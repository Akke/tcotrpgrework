LinkLuaModifier("modifier_tormentor_unyielding_shield_custom", "creeps/tormentor_unyielding_shield_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_tormentor_unyielding_shield_custom_pedestal_model", "creeps/tormentor_unyielding_shield_custom.lua", LUA_MODIFIER_MOTION_NONE)
