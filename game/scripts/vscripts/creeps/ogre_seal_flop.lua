LinkLuaModifier("modifier_ogre_seal_flop", "creeps/ogre_seal_flop.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ogre_seal_flop_active", "creeps/ogre_seal_flop.lua", LUA_MODIFIER_MOTION_BOTH)
