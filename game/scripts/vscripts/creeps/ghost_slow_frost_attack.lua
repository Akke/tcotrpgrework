LinkLuaModifier("modifier_ghost_slow_frost_attack", "creeps/ghost_slow_frost_attack.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ghost_slow_frost_attack_debuff", "creeps/ghost_slow_frost_attack.lua", LUA_MODIFIER_MOTION_NONE)
