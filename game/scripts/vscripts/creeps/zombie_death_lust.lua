LinkLuaModifier("modifier_zombie_death_lust", "creeps/zombie_death_lust.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zombie_death_lust_debuff", "creeps/zombie_death_lust.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zombie_death_lust_buff", "creeps/zombie_death_lust.lua", LUA_MODIFIER_MOTION_NONE)
