LinkLuaModifier("modifier_necronomicon_archer_ranged_aura", "creeps/necronomicon_archer/necronomicon_archer_ranged_aura.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_necronomicon_archer_ranged_aura_buff", "creeps/necronomicon_archer/necronomicon_archer_ranged_aura.lua", LUA_MODIFIER_MOTION_NONE)
