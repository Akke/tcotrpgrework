necronomicon_archer_split_shot = class({})
LinkLuaModifier( "modifier_necronomicon_archer_split_shot", "creeps/necronomicon_archer/necronomicon_archer_split_shot.lua", LUA_MODIFIER_MOTION_NONE )

--------------------------------------------------------------------------------
-- Passive Modifier
function necronomicon_archer_split_shot:GetIntrinsicModifierName()

    -- Default is using attack modifier for meme reasons with moon glaive
    return "modifier_necronomicon_archer_split_shot"
end

--------------------------------------------------------------------------------
-- Projectile
function necronomicon_archer_split_shot:OnProjectileHit( target, location )
...
modifier_necronomicon_archer_split_shot = class({})

--------------------------------------------------------------------------------
-- Classifications
function modifier_necronomicon_archer_split_shot:IsHidden()
    return true
end

function modifier_necronomicon_archer_split_shot:IsPurgable()
    return false
end

function modifier_necronomicon_archer_split_shot:GetPriority()
    return MODIFIER_PRIORITY_HIGH
end
--------------------------------------------------------------------------------
-- Initializations
function modifier_necronomicon_archer_split_shot:OnCreated( kv )
    -- references
...
function modifier_necronomicon_archer_split_shot:OnRefresh( kv )
    -- references
    self.reduction = self:GetAbility():GetSpecialValueFor( "damage_modifier" )
    self.count = self:GetAbility():GetSpecialValueFor( "arrow_count" )
    self.bonus_range = self:GetAbility():GetSpecialValueFor( "split_shot_bonus_range" )
...
function modifier_necronomicon_archer_split_shot:OnRemoved()
end

function modifier_necronomicon_archer_split_shot:OnDestroy()
end

--------------------------------------------------------------------------------
-- Modifier Effects
function modifier_necronomicon_archer_split_shot:DeclareFunctions()
    local funcs = {
...
function modifier_necronomicon_archer_split_shot:OnAttack( params )
    if not IsServer() then return end
...
function modifier_necronomicon_archer_split_shot:GetModifierDamageOutgoing_Percentage()
    if not IsServer() then return end
...
function modifier_necronomicon_archer_split_shot:SplitShotModifier( target )
    -- get radius
...
function modifier_necronomicon_archer_split_shot:SplitShotNoModifier( target )
    -- get radius
    local radius = self.parent:Script_GetAttackRange() + self.bonus_range
