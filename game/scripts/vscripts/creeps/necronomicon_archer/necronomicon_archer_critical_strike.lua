LinkLuaModifier("modifier_necronomicon_archer_critical_strike", "creeps/necronomicon_archer/necronomicon_archer_critical_strike.lua", LUA_MODIFIER_MOTION_NONE)
