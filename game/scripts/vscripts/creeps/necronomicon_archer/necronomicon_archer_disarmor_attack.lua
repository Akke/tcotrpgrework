LinkLuaModifier("modifier_necronomicon_archer_disarmor_attack", "creeps/necronomicon_archer/necronomicon_archer_disarmor_attack.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_necronomicon_archer_disarmor_attack_debuff", "creeps/necronomicon_archer/necronomicon_archer_disarmor_attack.lua", LUA_MODIFIER_MOTION_NONE)
