...
LinkLuaModifier( "modifier_creature_necrolyte_scythe_attack_thinker", "creeps/creature_necrolyte_scythe_attack/creature_necrolyte_scythe_attack.lua", LUA_MODIFIER_MOTION_NONE )
