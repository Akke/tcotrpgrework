LinkLuaModifier("modifier_lava_drake_flames_thinker", "creeps/lava_drake_flames.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lava_drake_flames_debuff", "creeps/lava_drake_flames.lua", LUA_MODIFIER_MOTION_NONE)
