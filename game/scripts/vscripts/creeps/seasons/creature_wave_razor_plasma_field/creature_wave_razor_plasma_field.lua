...
LinkLuaModifier( "modifier_creature_wave_razor_plasma_field", "creeps/seasons/creature_wave_razor_plasma_field/creature_wave_razor_plasma_field.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_creature_wave_razor_plasma_field_base", "creeps/seasons/creature_wave_razor_plasma_field/creature_wave_razor_plasma_field.lua", LUA_MODIFIER_MOTION_NONE )
