LinkLuaModifier("modifier_follower_skafian_healing", "creeps/follower_skafian_healing.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_follower_skafian_healing_aura", "creeps/follower_skafian_healing.lua", LUA_MODIFIER_MOTION_NONE)
