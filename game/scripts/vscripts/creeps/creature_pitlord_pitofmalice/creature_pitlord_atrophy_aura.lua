LinkLuaModifier("modifier_creature_pitlord_atrophy_aura", "creeps/creature_pitlord_pitofmalice/creature_pitlord_atrophy_aura.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_creature_pitlord_atrophy_aura_aura", "creeps/creature_pitlord_pitofmalice/creature_pitlord_atrophy_aura.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_creature_pitlord_atrophy_aura_buff", "creeps/creature_pitlord_pitofmalice/creature_pitlord_atrophy_aura.lua", LUA_MODIFIER_MOTION_NONE)
