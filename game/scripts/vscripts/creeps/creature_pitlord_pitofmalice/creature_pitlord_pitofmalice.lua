LinkLuaModifier("modifier_creature_pitlord_pitofmalice", "creeps/creature_pitlord_pitofmalice/creature_pitlord_pitofmalice.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_creature_pitlord_pitofmalice_aura", "creeps/creature_pitlord_pitofmalice/creature_pitlord_pitofmalice.lua", LUA_MODIFIER_MOTION_NONE)
