LinkLuaModifier("modifier_lava_elemental_attack", "creeps/lava_elemental_attack.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lava_elemental_attack_debuff", "creeps/lava_elemental_attack.lua", LUA_MODIFIER_MOTION_NONE)
