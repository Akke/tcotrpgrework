LinkLuaModifier("modifier_shaman_frost_nova", "creeps/shaman_frost_nova.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shaman_frost_nova_debuff", "creeps/shaman_frost_nova.lua", LUA_MODIFIER_MOTION_NONE)
