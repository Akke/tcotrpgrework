...
function modifier_scorching_malevolence_burning:OnCreated()
    ...
    self.damageTable = {
        ...
        damage = (damage + (self.caster:GetIntellect() * (burnIntToDamage / 100))) * self:GetStackCount(), 
        damage_type = DAMAGE_TYPE_MAGICAL,
...
function modifier_scorching_malevolence_burning:OnStackCountChanged()
    ...
    self.damageTable.damage = (damage + (self.caster:GetIntellect() * (burnIntToDamage / 100))) * self:GetStackCount()
end
