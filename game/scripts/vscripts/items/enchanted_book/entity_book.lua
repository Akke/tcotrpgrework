...
item_entity_book = class(ItemBaseClass)

function item_entity_book:OnSpellStart()
  ...
  if _G.PlayerAddedAbilityCount[accountID] == nil then
      ...
      if (allPlayerAbilities ~= nil and #allPlayerAbilities >= 8) then DisplayError(caster:GetPlayerID(), "Limit Reached") return end
