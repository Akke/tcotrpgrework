LinkLuaModifier("modifier_item_martyrs_plate_custom", "items/item_martyrs_plate_custom/item_martyrs_plate_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_martyrs_plate_custom_aura", "items/item_martyrs_plate_custom/item_martyrs_plate_custom.lua", LUA_MODIFIER_MOTION_NONE)
