LinkLuaModifier("modifier_item_dead_book", "items/item_dead_book/item_dead_book.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_dead_book_debuff", "items/item_dead_book/item_dead_book.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_dead_book_aura", "items/item_dead_book/item_dead_book.lua", LUA_MODIFIER_MOTION_NONE)
