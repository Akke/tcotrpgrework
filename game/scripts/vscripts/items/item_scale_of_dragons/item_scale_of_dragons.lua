LinkLuaModifier("modifier_item_scale_of_dragons", "items/item_scale_of_dragons/item_scale_of_dragons.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_scale_of_dragons_debuff", "items/item_scale_of_dragons/item_scale_of_dragons.lua", LUA_MODIFIER_MOTION_NONE)
