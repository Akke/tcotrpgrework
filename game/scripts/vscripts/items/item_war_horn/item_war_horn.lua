LinkLuaModifier("modifier_item_war_horn", "items/item_war_horn/item_war_horn.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_war_horn_buff", "items/item_war_horn/item_war_horn.lua", LUA_MODIFIER_MOTION_NONE)
