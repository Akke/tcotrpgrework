...
function modifier_item_moon_shard_custom_stacks:GetTexture()
...
function modifier_item_moon_shard_custom_stacks:GetModifierAttackSpeedBonus_Constant()
    return self.fAttack_Speed * self:GetStackCount()
end
...
function modifier_item_moon_shard_custom_stacks:InvokeBonusAttackSpeed()
    if IsServer() == true then
        self.fAttack_Speed = self.attack_speed
