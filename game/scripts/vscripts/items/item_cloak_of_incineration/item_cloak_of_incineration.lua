LinkLuaModifier("modifier_item_cloak_of_incineration", "items/item_cloak_of_incineration/item_cloak_of_incineration.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_cloak_of_incineration_self", "items/item_cloak_of_incineration/item_cloak_of_incineration.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_cloak_of_incineration_bonus", "items/item_cloak_of_incineration/item_cloak_of_incineration.lua", LUA_MODIFIER_MOTION_NONE)
