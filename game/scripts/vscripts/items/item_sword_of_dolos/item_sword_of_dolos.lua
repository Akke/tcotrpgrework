LinkLuaModifier("modifier_item_sword_of_dolos", "items/item_sword_of_dolos/item_sword_of_dolos.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_sword_of_dolos_debuff", "items/item_sword_of_dolos/item_sword_of_dolos.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_sword_of_dolos_active", "items/item_sword_of_dolos/item_sword_of_dolos.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_item_sword_of_dolos:GetModifierTotalDamageOutgoing_Percentage(event)
    if IsServer() then
        ...
        -- Find targets back
        -- Thanks to DOTA IMBA for the code (https://github.com/EarthSalamander42/dota_imba/blob/master/game/scripts/vscripts/components/abilities/heroes/hero_riki.lua#L1193)
