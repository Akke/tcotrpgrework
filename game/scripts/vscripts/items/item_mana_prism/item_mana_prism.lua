LinkLuaModifier("modifier_item_mana_prism", "items/item_mana_prism/item_mana_prism.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_mana_prism_casting", "items/item_mana_prism/item_mana_prism.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_mana_prism_debuff", "items/item_mana_prism/item_mana_prism.lua", LUA_MODIFIER_MOTION_NONE)
