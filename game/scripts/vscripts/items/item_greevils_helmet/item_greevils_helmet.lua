LinkLuaModifier("modifier_item_greevils_helmet", "items/item_greevils_helmet/item_greevils_helmet.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_greevils_helmet_buff", "items/item_greevils_helmet/item_greevils_helmet.lua", LUA_MODIFIER_MOTION_NONE)
