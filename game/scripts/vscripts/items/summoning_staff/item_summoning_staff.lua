LinkLuaModifier("modifier_item_summoning_staff", "items/summoning_staff/item_summoning_staff.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_summoning_staff_aura", "items/summoning_staff/item_summoning_staff.lua", LUA_MODIFIER_MOTION_NONE)
