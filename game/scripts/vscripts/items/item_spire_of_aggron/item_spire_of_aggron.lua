LinkLuaModifier("modifier_item_spire_of_aggron", "items/item_spire_of_aggron/item_spire_of_aggron.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_spire_of_aggron_buff", "items/item_spire_of_aggron/item_spire_of_aggron.lua", LUA_MODIFIER_MOTION_NONE)
