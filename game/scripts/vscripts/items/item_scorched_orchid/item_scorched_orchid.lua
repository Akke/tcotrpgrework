LinkLuaModifier("modifier_item_scorched_orchid", "items/item_scorched_orchid/item_scorched_orchid.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_scorched_orchid_debuff", "items/item_scorched_orchid/item_scorched_orchid.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_scorched_orchid_stored_damage", "items/item_scorched_orchid/item_scorched_orchid.lua", LUA_MODIFIER_MOTION_NONE)
