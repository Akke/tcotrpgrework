LinkLuaModifier("modifier_item_overlord_helmet", "items/item_overlord_helmet/item_overlord_helmet.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_overlord_helmet_aura", "items/item_overlord_helmet/item_overlord_helmet.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_overlord_helmet_aura_friendly", "items/item_overlord_helmet/item_overlord_helmet.lua", LUA_MODIFIER_MOTION_NONE)
