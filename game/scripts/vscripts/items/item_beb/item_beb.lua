LinkLuaModifier("modifier_item_beb", "items/item_beb/item_beb.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_beb_aura", "items/item_beb/item_beb.lua", LUA_MODIFIER_MOTION_NONE)
