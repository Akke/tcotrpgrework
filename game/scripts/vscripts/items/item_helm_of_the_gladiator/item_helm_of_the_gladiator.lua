LinkLuaModifier("modifier_item_helm_of_the_gladiator", "items/item_helm_of_the_gladiator/item_helm_of_the_gladiator.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_helm_of_the_gladiator_stacks", "items/item_helm_of_the_gladiator/item_helm_of_the_gladiator.lua", LUA_MODIFIER_MOTION_NONE)
