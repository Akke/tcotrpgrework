LinkLuaModifier("modifier_item_shamans_sword", "items/item_shamans_sword/item_shamans_sword.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_shamans_sword_stacks", "items/item_shamans_sword/item_shamans_sword.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_shamans_sword_vulnerable", "items/item_shamans_sword/item_shamans_sword.lua", LUA_MODIFIER_MOTION_NONE)
