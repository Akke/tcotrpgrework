LinkLuaModifier("modifier_item_veil_of_discord_custom", "items/item_veil_of_discord_custom/item_veil_of_discord_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_veil_of_discord_custom_mana_regen_aura", "items/item_veil_of_discord_custom/item_veil_of_discord_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_veil_of_discord_custom_magic_weakness_aura_emitter", "items/item_veil_of_discord_custom/item_veil_of_discord_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_veil_of_discord_custom_blaze_aura_emitter", "items/item_veil_of_discord_custom/item_veil_of_discord_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_veil_of_discord_custom_magic_weakness_aura", "items/item_veil_of_discord_custom/item_veil_of_discord_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_veil_of_discord_custom_blaze_aura", "items/item_veil_of_discord_custom/item_veil_of_discord_custom.lua", LUA_MODIFIER_MOTION_NONE)
