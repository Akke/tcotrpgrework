LinkLuaModifier("modifier_item_ristul_dagger", "items/item_ristul_dagger/item_ristul_dagger.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_ristul_dagger_buff", "items/item_ristul_dagger/item_ristul_dagger.lua", LUA_MODIFIER_MOTION_NONE)
