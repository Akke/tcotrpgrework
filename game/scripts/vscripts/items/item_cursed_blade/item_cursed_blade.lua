LinkLuaModifier("modifier_item_cursed_blade", "items/item_cursed_blade/item_cursed_blade.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_cursed_blade_damage_debuff", "items/item_cursed_blade/item_cursed_blade.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_cursed_blade_damage_buff", "items/item_cursed_blade/item_cursed_blade.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_cursed_blade_aura", "items/item_cursed_blade/item_cursed_blade.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_cursed_blade_stacking_buff", "items/item_cursed_blade/item_cursed_blade.lua", LUA_MODIFIER_MOTION_NONE)
