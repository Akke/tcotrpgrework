LinkLuaModifier("modifier_aeon_of_tarrasque", "items/aeon_of_tarrasque/item_aeon_of_tarrasque.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_aeon_of_tarrasque_immunity", "items/aeon_of_tarrasque/item_aeon_of_tarrasque.lua", LUA_MODIFIER_MOTION_NONE)
