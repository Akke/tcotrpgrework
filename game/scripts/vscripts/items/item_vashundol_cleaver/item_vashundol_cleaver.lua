LinkLuaModifier("modifier_vashundol_cleaver", "items/item_vashundol_cleaver/item_vashundol_cleaver.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_vashundol_cleaver_disarmor", "items/item_vashundol_cleaver/item_vashundol_cleaver.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_vashundol_cleaver_buff", "items/item_vashundol_cleaver/item_vashundol_cleaver.lua", LUA_MODIFIER_MOTION_NONE)
