LinkLuaModifier("modifier_item_apotheosis_blade", "items/item_apotheosis_blade/item_apotheosis_blade.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_apotheosis_blade_pool_debuff", "items/item_apotheosis_blade/item_apotheosis_blade.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_apotheosis_blade_pool_thinker", "items/item_apotheosis_blade/item_apotheosis_blade.lua", LUA_MODIFIER_MOTION_NONE)
