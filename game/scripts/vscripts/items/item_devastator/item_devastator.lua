LinkLuaModifier("modifier_item_devastator", "items/item_devastator/item_devastator.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_devastator_buff", "items/item_devastator/item_devastator.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_devastator_debuff", "items/item_devastator/item_devastator.lua", LUA_MODIFIER_MOTION_NONE)
