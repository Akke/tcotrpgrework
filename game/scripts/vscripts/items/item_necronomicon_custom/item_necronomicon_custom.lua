LinkLuaModifier("modifier_item_necronomicon_custom", "items/item_necronomicon_custom/item_necronomicon_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_necronomicon_custom_archer", "items/item_necronomicon_custom/item_necronomicon_custom.lua", LUA_MODIFIER_MOTION_NONE)
