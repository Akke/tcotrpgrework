LinkLuaModifier("modifier_item_heavens_counter", "items/item_heavens_counter/item_heavens_counter.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_heavens_counter_disarm", "items/item_heavens_counter/item_heavens_counter.lua", LUA_MODIFIER_MOTION_NONE)
