LinkLuaModifier("modifier_item_eloshar_bracelet", "items/item_eloshar_bracelet/item_eloshar_bracelet.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_eloshar_bracelet_stacks", "items/item_eloshar_bracelet/item_eloshar_bracelet.lua", LUA_MODIFIER_MOTION_NONE)
