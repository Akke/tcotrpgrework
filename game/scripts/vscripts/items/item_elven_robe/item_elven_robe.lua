LinkLuaModifier("modifier_item_elven_robe", "items/item_elven_robe/item_elven_robe.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_elven_robe_attack_buff", "items/item_elven_robe/item_elven_robe.lua", LUA_MODIFIER_MOTION_NONE)
