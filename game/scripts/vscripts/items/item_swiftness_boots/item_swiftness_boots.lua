LinkLuaModifier("modifier_swiftness_boots", "items/item_swiftness_boots/item_swiftness_boots.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_swiftness_boots_teleporting", "items/item_swiftness_boots/item_swiftness_boots.lua", LUA_MODIFIER_MOTION_NONE)
