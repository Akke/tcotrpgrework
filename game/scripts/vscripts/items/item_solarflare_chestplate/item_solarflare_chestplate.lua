LinkLuaModifier("modifier_item_solarflare_chestplate", "items/item_solarflare_chestplate/item_solarflare_chestplate.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_solarflare_chestplate_burn", "items/item_solarflare_chestplate/item_solarflare_chestplate.lua", LUA_MODIFIER_MOTION_NONE)
