LinkLuaModifier("modifier_item_destruction_orb", "items/item_destruction_orb/item_destruction_orb.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_destruction_orb_debuff", "items/item_destruction_orb/item_destruction_orb.lua", LUA_MODIFIER_MOTION_NONE)
