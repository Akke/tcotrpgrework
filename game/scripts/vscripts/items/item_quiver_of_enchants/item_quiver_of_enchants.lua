LinkLuaModifier("modifier_item_quiver_of_enchants", "items/item_quiver_of_enchants/item_quiver_of_enchants.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_quiver_of_enchants_buff", "items/item_quiver_of_enchants/item_quiver_of_enchants.lua", LUA_MODIFIER_MOTION_NONE)
