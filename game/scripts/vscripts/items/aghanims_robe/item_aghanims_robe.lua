LinkLuaModifier("modifier_item_aghanims_robe", "items/aghanims_robe/item_aghanims_robe.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_aghanims_robe_active", "items/aghanims_robe/item_aghanims_robe.lua", LUA_MODIFIER_MOTION_NONE)
