LinkLuaModifier("modifier_item_blood_drainer", "items/item_blood_drainer/item_blood_drainer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_blood_drainer_toggle", "items/item_blood_drainer/item_blood_drainer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_blood_drainer_particle", "items/item_blood_drainer/item_blood_drainer.lua", LUA_MODIFIER_MOTION_NONE)
