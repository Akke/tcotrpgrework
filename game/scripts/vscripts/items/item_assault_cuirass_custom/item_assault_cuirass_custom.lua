LinkLuaModifier("modifier_item_assault_cuirass_custom", "items/item_assault_cuirass_custom/item_assault_cuirass_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_assault_cuirass_custom_aura", "items/item_assault_cuirass_custom/item_assault_cuirass_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_assault_cuirass_custom_aura_enemy", "items/item_assault_cuirass_custom/item_assault_cuirass_custom.lua", LUA_MODIFIER_MOTION_NONE)
