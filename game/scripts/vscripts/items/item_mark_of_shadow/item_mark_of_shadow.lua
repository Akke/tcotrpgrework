LinkLuaModifier("modifier_item_mark_of_shadow", "items/item_mark_of_shadow/item_mark_of_shadow.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_mark_of_shadow_regen", "items/item_mark_of_shadow/item_mark_of_shadow.lua", LUA_MODIFIER_MOTION_NONE)
