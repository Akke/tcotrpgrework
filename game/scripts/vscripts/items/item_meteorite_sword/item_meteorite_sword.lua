LinkLuaModifier("modifier_item_meteorite_sword", "items/item_meteorite_sword/item_meteorite_sword.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_meteorite_sword_active", "items/item_meteorite_sword/item_meteorite_sword.lua", LUA_MODIFIER_MOTION_NONE)
