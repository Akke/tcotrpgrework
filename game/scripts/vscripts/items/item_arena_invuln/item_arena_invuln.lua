LinkLuaModifier("modifier_item_arena_invuln", "items/item_arena_invuln/item_arena_invuln.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_arena_invuln_buff", "items/item_arena_invuln/item_arena_invuln.lua", LUA_MODIFIER_MOTION_NONE)
