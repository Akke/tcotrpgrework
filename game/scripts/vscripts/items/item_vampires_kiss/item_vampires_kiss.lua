LinkLuaModifier("modifier_item_vampires_kiss", "items/item_vampires_kiss/item_vampires_kiss.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_vampires_kiss_shield", "items/item_vampires_kiss/item_vampires_kiss.lua", LUA_MODIFIER_MOTION_NONE)
