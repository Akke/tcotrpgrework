...
LinkLuaModifier("modifier_item_armor_piercing_crossbow_debuff", "armor_piercing_crossbow.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_armor_piercing_crossbow_active", "armor_piercing_crossbow.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_armor_piercing_crossbow_dawn_debuff", "armor_piercing_crossbow.lua", LUA_MODIFIER_MOTION_NONE)
