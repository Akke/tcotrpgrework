...
LinkLuaModifier("modifier_xp_strength_talent_4_magical", "abilities/talents/strength/xp_strength_talent_4.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_xp_strength_talent_4_physical", "abilities/talents/strength/xp_strength_talent_4.lua", LUA_MODIFIER_MOTION_NONE)
