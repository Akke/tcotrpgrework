...
LinkLuaModifier("modifier_xp_strength_talent_13_buff", "abilities/talents/strength/xp_strength_talent_13.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_xp_strength_talent_13_cd", "abilities/talents/strength/xp_strength_talent_13.lua", LUA_MODIFIER_MOTION_NONE)
