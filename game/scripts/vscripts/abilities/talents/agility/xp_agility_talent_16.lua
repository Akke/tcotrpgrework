...
LinkLuaModifier("modifier_xp_agility_talent_16_aura", "abilities/talents/agility/xp_agility_talent_16.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_xp_agility_talent_16_aura_self", "abilities/talents/agility/xp_agility_talent_16.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_xp_agility_talent_16_buff", "abilities/talents/agility/xp_agility_talent_16.lua", LUA_MODIFIER_MOTION_NONE)
