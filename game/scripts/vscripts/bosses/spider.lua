...
LinkLuaModifier("modifier_boss_spider_follower_web_ai", "bosses/spider.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_spider_follower_web_spider_ai", "bosses/spider.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_spider_follower_web_spider_ai_detonating", "bosses/spider.lua", LUA_MODIFIER_MOTION_NONE)
