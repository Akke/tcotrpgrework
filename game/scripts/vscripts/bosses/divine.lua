LinkLuaModifier("modifier_boss_divine", "bosses/divine.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_divine_follower", "bosses/divine.lua", LUA_MODIFIER_MOTION_NONE)
