...
LinkLuaModifier("modifier_legion_commander_duel_custom_window", "legion_commander_duel_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_legion_commander_duel_custom_window_cooldown", "legion_commander_duel_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_legion_commander_duel_custom_window_boost", "legion_commander_duel_custom.lua", LUA_MODIFIER_MOTION_NONE)
