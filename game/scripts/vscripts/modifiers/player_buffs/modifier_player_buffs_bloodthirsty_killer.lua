...
LinkLuaModifier("modifier_player_buffs_bloodthirsty_killer_buff", "modifiers/player_buffs/modifier_player_buffs_bloodthirsty_killer.lua", LUA_MODIFIER_MOTION_NONE)
