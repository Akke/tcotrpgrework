...
LinkLuaModifier("modifier_player_buffs_blood_pool_emitter", "modifiers/player_buffs/modifier_player_buffs_blood_pool.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_player_buffs_blood_pool_emitter_aura", "modifiers/player_buffs/modifier_player_buffs_blood_pool.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_player_buffs_blood_pool_emitter_aura_enemy", "modifiers/player_buffs/modifier_player_buffs_blood_pool.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_player_buffs_blood_pool_shield", "modifiers/player_buffs/modifier_player_buffs_blood_pool.lua", LUA_MODIFIER_MOTION_NONE)
