...
LinkLuaModifier("modifier_player_buffs_adrenaline_buff", "modifiers/player_buffs/modifier_player_buffs_adrenaline.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_player_buffs_adrenaline_debuff", "modifiers/player_buffs/modifier_player_buffs_adrenaline.lua", LUA_MODIFIER_MOTION_NONE)
