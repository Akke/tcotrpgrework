...
LinkLuaModifier("modifier_player_buffs_omniscent_blessing_damage", "modifiers/player_buffs/modifier_player_buffs_omniscent_blessing.lua", LUA_MODIFIER_MOTION_NONE)
