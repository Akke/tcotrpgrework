...
LinkLuaModifier("modifier_apocalypse_rushing_buff", "modifiers/apocalypse_modifiers/rushing.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_apocalypse_rushing_cooldown", "modifiers/apocalypse_modifiers/rushing.lua", LUA_MODIFIER_MOTION_NONE)
