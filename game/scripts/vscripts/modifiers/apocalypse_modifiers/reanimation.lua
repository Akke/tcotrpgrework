...
LinkLuaModifier("modifier_apocalypse_reanimation_reanimated", "modifiers/apocalypse_modifiers/reanimation.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_apocalypse_reanimation_prevent_death", "modifiers/apocalypse_modifiers/reanimation.lua", LUA_MODIFIER_MOTION_NONE)
