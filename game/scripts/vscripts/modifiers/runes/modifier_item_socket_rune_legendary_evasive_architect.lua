...
LinkLuaModifier("modifier_item_socket_rune_legendary_evasive_architect_cooldown", "modifiers/runes/modifier_item_socket_rune_legendary_evasive_architect.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_socket_rune_legendary_evasive_architect_buff", "modifiers/runes/modifier_item_socket_rune_legendary_evasive_architect.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_socket_rune_legendary_evasive_architect_debuff", "modifiers/runes/modifier_item_socket_rune_legendary_evasive_architect.lua", LUA_MODIFIER_MOTION_NONE)
