...
LinkLuaModifier("modifier_item_socket_rune_legendary_adrenaline_buff", "modifiers/runes/modifier_item_socket_rune_legendary_adrenaline.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_socket_rune_legendary_adrenaline_cooldown", "modifiers/runes/modifier_item_socket_rune_legendary_adrenaline.lua", LUA_MODIFIER_MOTION_NONE)
