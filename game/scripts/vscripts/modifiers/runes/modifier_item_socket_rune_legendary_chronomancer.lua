...
LinkLuaModifier("modifier_item_socket_rune_legendary_chronomancer_buff", "modifiers/runes/modifier_item_socket_rune_legendary_chronomancer.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_socket_rune_legendary_chronomancer_cd", "modifiers/runes/modifier_item_socket_rune_legendary_chronomancer.lua", LUA_MODIFIER_MOTION_NONE)
