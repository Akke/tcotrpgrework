...
LinkLuaModifier("modifier_item_socket_rune_legendary_blood_rush_buff", "modifiers/runes/modifier_item_socket_rune_legendary_blood_rush.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_socket_rune_legendary_blood_rush_cooldown", "modifiers/runes/modifier_item_socket_rune_legendary_blood_rush.lua", LUA_MODIFIER_MOTION_NONE)
