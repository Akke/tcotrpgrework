...
LinkLuaModifier("modifier_item_socket_rune_legendary_exodus_shield_buff", "modifiers/runes/modifier_item_socket_rune_legendary_exodus_shield.lua", LUA_MODIFIER_MOTION_NONE)
