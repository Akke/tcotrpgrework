...
LinkLuaModifier("modifier_item_socket_rune_legendary_rejuvenation_buff", "modifiers/runes/modifier_item_socket_rune_legendary_rejuvenation.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_item_socket_rune_legendary_rejuvenation_cooldown", "modifiers/runes/modifier_item_socket_rune_legendary_rejuvenation.lua", LUA_MODIFIER_MOTION_NONE)
