...
LinkLuaModifier("modifier_season_firestorm_emitter", "modifiers/seasons/modifier_season_firestorm.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_season_firestorm_debuff", "modifiers/seasons/modifier_season_firestorm.lua", LUA_MODIFIER_MOTION_NONE)
