...
LinkLuaModifier("modifier_season_shock_emitter", "modifiers/seasons/modifier_season_shock.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_season_shock_debuff", "modifiers/seasons/modifier_season_shock.lua", LUA_MODIFIER_MOTION_NONE)
