...
LinkLuaModifier("modifier_season_lightning_emitter", "modifiers/seasons/modifier_season_lightning.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_season_lightning_debuff", "modifiers/seasons/modifier_season_lightning.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_season_lightning_aura", "modifiers/seasons/modifier_season_lightning.lua", LUA_MODIFIER_MOTION_NONE)
