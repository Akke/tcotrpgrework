...
LinkLuaModifier("modifier_enemy_difficulty_buff_petrify_10_petrified", "modifiers/modes/buffs/hard/modifier_enemy_difficulty_buff_petrify_10.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_enemy_difficulty_buff_petrify_10_cooldown", "modifiers/modes/buffs/hard/modifier_enemy_difficulty_buff_petrify_10.lua", LUA_MODIFIER_MOTION_NONE)
