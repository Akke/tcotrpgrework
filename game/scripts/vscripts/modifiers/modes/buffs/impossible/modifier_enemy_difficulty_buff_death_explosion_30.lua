...
enemy_difficulty_buff_death_explosion_30 = class({
    IsPurgable = function(self) return false end,
    RemoveOnDeath = function(self) return false end,
    IsHidden = function(self) return false end,
    IsStackable = function(self) return false end,
...
modifier_enemy_difficulty_buff_death_explosion_30 = class(ItemBaseClass)

function enemy_difficulty_buff_death_explosion_30:GetIntrinsicModifierName()
    return "modifier_enemy_difficulty_buff_death_explosion_30"
end

function modifier_enemy_difficulty_buff_death_explosion_30:GetTexture() return "skull" end
-------------
function modifier_enemy_difficulty_buff_death_explosion_30:DeclareFunctions()
    local funcs = {
...
function modifier_enemy_difficulty_buff_death_explosion_30:OnDeath(event)
    ...
    for _,victim in ipairs(victims) do
        ...
        then
            local dmg = unit:GetMaxHealth() * 0.30
...
function modifier_enemy_difficulty_buff_death_explosion_30:PlayEffect(target)
