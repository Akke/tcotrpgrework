...
LinkLuaModifier("modifier_player_difficulty_boon_leaky_5_hp_debuff", "modifiers/modes/buffs/impossible/modifier_player_difficulty_boon_leaky_5.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_player_difficulty_boon_leaky_5_mana_debuff", "modifiers/modes/buffs/impossible/modifier_player_difficulty_boon_leaky_5.lua", LUA_MODIFIER_MOTION_NONE)
