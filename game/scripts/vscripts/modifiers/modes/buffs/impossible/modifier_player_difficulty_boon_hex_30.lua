...
LinkLuaModifier("modifier_player_difficulty_boon_hex_30_countdown", "modifiers/modes/buffs/impossible/modifier_player_difficulty_boon_hex_30.lua", LUA_MODIFIER_MOTION_NONE)
