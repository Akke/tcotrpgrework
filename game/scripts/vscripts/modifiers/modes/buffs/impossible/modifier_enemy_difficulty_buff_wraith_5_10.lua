...
LinkLuaModifier("modifier_enemy_difficulty_buff_wraith_5_10_buff_disabled", "modifiers/modes/buffs/impossible/modifier_enemy_difficulty_buff_wraith_5_10.lua", LUA_MODIFIER_MOTION_NONE)
