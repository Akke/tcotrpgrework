...
LinkLuaModifier("modifier_enemy_difficulty_buff_petrify_40_petrified", "modifiers/modes/buffs/unfair/modifier_enemy_difficulty_buff_petrify_40.lua", LUA_MODIFIER_MOTION_NONE)
