...
LinkLuaModifier("modifier_enemy_difficulty_buff_mana_burn_5_cooldown", "modifiers/modes/buffs/unfair/modifier_enemy_difficulty_buff_mana_burn_5.lua", LUA_MODIFIER_MOTION_NONE)
