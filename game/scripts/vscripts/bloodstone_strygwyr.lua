...
LinkLuaModifier("modifier_bloodstone_strygwyr_kill_counter", "bloodstone_strygwyr.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_bloodstone_strygwyr_overheal_shield", "bloodstone_strygwyr.lua", LUA_MODIFIER_MOTION_NONE)
