LinkLuaModifier("modifier_bloodseeker_ritual_custom", "heroes/hero_bloodseeker/bloodseeker_ritual_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_bloodseeker_ritual_custom_thinker", "heroes/hero_bloodseeker/bloodseeker_ritual_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_bloodseeker_ritual_custom_debuff", "heroes/hero_bloodseeker/bloodseeker_ritual_custom.lua", LUA_MODIFIER_MOTION_NONE)
