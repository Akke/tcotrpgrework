...
LinkLuaModifier("modifier_bloodseeker_bloodrage_custom_enrage", "heroes/hero_bloodseeker/bloodrage.lua", LUA_MODIFIER_MOTION_NONE) --- PETH WEFY INPARFANT
LinkLuaModifier("modifier_bloodseeker_bloodrage_custom_enrage_cd", "heroes/hero_bloodseeker/bloodrage.lua", LUA_MODIFIER_MOTION_NONE) --- PETH WEFY INPARFANT
