LinkLuaModifier("modifier_talent_bloodseeker_2", "heroes/hero_bloodseeker/talents/talent_bloodseeker_2.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_talent_bloodseeker_2_buff", "heroes/hero_bloodseeker/talents/talent_bloodseeker_2.lua", LUA_MODIFIER_MOTION_NONE)
