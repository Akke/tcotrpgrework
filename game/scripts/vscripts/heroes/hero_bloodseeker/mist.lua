...
LinkLuaModifier("modifier_bloodseeker_blood_mist_custom_stacks", "heroes/hero_bloodseeker/mist.lua", LUA_MODIFIER_MOTION_NONE)
...
LinkLuaModifier("modifier_bloodseeker_blood_mist_custom_self_drain", "heroes/hero_bloodseeker/mist.lua", LUA_MODIFIER_MOTION_NONE)
