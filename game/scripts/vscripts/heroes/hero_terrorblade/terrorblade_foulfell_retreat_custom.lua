LinkLuaModifier("modifier_terrorblade_foulfell_retreat_custom", "heroes/hero_terrorblade/terrorblade_foulfell_retreat_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_terrorblade_foulfell_retreat_custom_buff", "heroes/hero_terrorblade/terrorblade_foulfell_retreat_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_terrorblade_foulfell_retreat_custom_debuff", "heroes/hero_terrorblade/terrorblade_foulfell_retreat_custom.lua", LUA_MODIFIER_MOTION_NONE)
