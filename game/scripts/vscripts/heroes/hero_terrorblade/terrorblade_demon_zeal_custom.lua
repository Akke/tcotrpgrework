LinkLuaModifier("modifier_terrorblade_demon_zeal_custom", "heroes/hero_terrorblade/terrorblade_demon_zeal_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_terrorblade_demon_zeal_custom_buff", "heroes/hero_terrorblade/terrorblade_demon_zeal_custom.lua", LUA_MODIFIER_MOTION_NONE)
