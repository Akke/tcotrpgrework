...
function modifier_terrorblade_metamorphosis_unleashed_custom:GetModifierProcAttack_BonusDamage_Pure(params)
    if IsServer() then
        -- get target
        ...
        local total = params.damage * (damageConversion / 100)
