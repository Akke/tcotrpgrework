...
LinkLuaModifier( "modifier_terrorblade_metamorphosis_custom", "heroes/hero_terrorblade/terrorblade_metamorphosis_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_terrorblade_metamorphosis_custom_aura", "heroes/hero_terrorblade/terrorblade_metamorphosis_custom.lua", LUA_MODIFIER_MOTION_NONE )
