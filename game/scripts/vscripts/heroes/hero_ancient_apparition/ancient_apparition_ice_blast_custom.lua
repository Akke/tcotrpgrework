LinkLuaModifier("modifier_ancient_apparition_ice_blast_custom", "heroes/hero_ancient_apparition/ancient_apparition_ice_blast_custom.lua", LUA_MODIFIER_MOTION_BOTH)
LinkLuaModifier("modifier_ancient_apparition_ice_blast_custom_debuff", "heroes/hero_ancient_apparition/ancient_apparition_ice_blast_custom.lua", LUA_MODIFIER_MOTION_BOTH)
LinkLuaModifier("modifier_ancient_apparition_ice_blast_custom_frozen", "heroes/hero_ancient_apparition/ancient_apparition_ice_blast_custom.lua", LUA_MODIFIER_MOTION_BOTH)
LinkLuaModifier("modifier_ancient_apparition_ice_blast_custom_slowed", "heroes/hero_ancient_apparition/ancient_apparition_ice_blast_custom.lua", LUA_MODIFIER_MOTION_BOTH)
...
function ancient_apparition_ice_blast_custom:OnProjectileHit(target, loc)
    ...
    if caster:IsRealHero() then
        intellectDamage = caster:GetIntellect()
    end
...
function modifier_ancient_apparition_ice_blast_custom:OnRemoved()
    ...
    local ability = self:GetAbility()
    local radius = ability:GetSpecialValueFor("radius")
    local damage = ability:GetSpecialValueFor("damage") + (self.parent:GetIntellect() * (ability:GetSpecialValueFor("int_to_damage")/100))
