LinkLuaModifier("modifier_ancient_apparition_chilling_touch_custom", "heroes/hero_ancient_apparition/ancient_apparition_chilling_touch_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ancient_apparition_chilling_touch_custom_slow_debuff", "heroes/hero_ancient_apparition/ancient_apparition_chilling_touch_custom.lua", LUA_MODIFIER_MOTION_NONE)
