LinkLuaModifier("modifier_ancient_apparition_frozen_time", "heroes/hero_ancient_apparition/ancient_apparition_frozen_time.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ancient_apparition_frozen_time_scepter_buff", "heroes/hero_ancient_apparition/ancient_apparition_frozen_time.lua", LUA_MODIFIER_MOTION_NONE)
