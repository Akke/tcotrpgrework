LinkLuaModifier("modifier_ancient_apparition_chilling_barrier", "heroes/hero_ancient_apparition/ancient_apparition_chilling_barrier.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ancient_apparition_chilling_barrier_absorb_state", "heroes/hero_ancient_apparition/ancient_apparition_chilling_barrier.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ancient_apparition_chilling_barrier_debuff", "heroes/hero_ancient_apparition/ancient_apparition_chilling_barrier.lua", LUA_MODIFIER_MOTION_NONE)
