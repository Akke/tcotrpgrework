LinkLuaModifier("modifier_ancient_apparition_chilling_ground", "heroes/hero_ancient_apparition/ancient_apparition_chilling_ground.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ancient_apparition_chilling_ground_emitter", "heroes/hero_ancient_apparition/ancient_apparition_chilling_ground.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ancient_apparition_chilling_ground_emitter_aura", "heroes/hero_ancient_apparition/ancient_apparition_chilling_ground.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ancient_apparition_chilling_frozen_debuff", "heroes/hero_ancient_apparition/ancient_apparition_chilling_ground.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_ancient_apparition_chilling_ground_emitter:OnIntervalThink()
    ...
    if self.caster:IsRealHero() then
        intellectDamage = self.caster:GetIntellect()
    end
