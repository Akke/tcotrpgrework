...
LinkLuaModifier("modifier_underlord_atrophy_aura_custom_buff_permanent", "heroes/hero_underlord/underlord_atrophy_aura_custom.lua", LUA_MODIFIER_MOTION_NONE)
