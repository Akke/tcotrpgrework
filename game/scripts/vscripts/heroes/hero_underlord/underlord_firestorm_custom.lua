...
LinkLuaModifier( "modifier_underlord_firestorm_custom_debuff", "heroes/hero_underlord/underlord_firestorm_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_underlord_firestorm_custom_thinker", "heroes/hero_underlord/underlord_firestorm_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_underlord_firestorm_custom", "heroes/hero_underlord/underlord_firestorm_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_underlord_firestorm_custom_procattack_cooldown", "heroes/hero_underlord/underlord_firestorm_custom.lua", LUA_MODIFIER_MOTION_NONE )
