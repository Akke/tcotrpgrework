LinkLuaModifier("modifier_underlord_pit_of_abyss_custom", "heroes/hero_underlord/underlord_pit_of_abyss_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_underlord_pit_of_abyss_custom_buff", "heroes/hero_underlord/underlord_pit_of_abyss_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_underlord_pit_of_abyss_custom_aura", "heroes/hero_underlord/underlord_pit_of_abyss_custom.lua", LUA_MODIFIER_MOTION_NONE)
