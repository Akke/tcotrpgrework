...
LinkLuaModifier( "modifier_underlord_pit_of_malice_custom", "heroes/hero_underlord/underlord_pit_of_malice_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_underlord_pit_of_malice_custom_cooldown", "heroes/hero_underlord/underlord_pit_of_malice_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_underlord_pit_of_malice_custom_thinker", "heroes/hero_underlord/underlord_pit_of_malice_custom.lua", LUA_MODIFIER_MOTION_NONE )
