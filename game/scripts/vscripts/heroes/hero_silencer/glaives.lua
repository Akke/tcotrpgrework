...
function silencer_glaives_of_wisdom_custom:GetManaCost(level)
...
function modifier_silencer_glaives_of_wisdom_custom_buff:OnRefresh()
    ...
    self.total = ((parent:GetIntellect()-self.total) * (ability:GetSpecialValueFor("int_gain_pct")/100)) * self:GetStackCount()
