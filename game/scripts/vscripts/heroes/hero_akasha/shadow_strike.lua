LinkLuaModifier("hero_akasha_shadow_strike_modifier", "heroes/hero_akasha/shadow_strike.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("hero_akasha_shadow_strike_modifier_debuff", "heroes/hero_akasha/shadow_strike.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("hero_akasha_shadow_strike_modifier_damage_debuff", "heroes/hero_akasha/shadow_strike.lua", LUA_MODIFIER_MOTION_NONE)
...
function hero_akasha_shadow_strike_modifier_debuff:OnCreated(params)
    ...
    self.damage = params.damage+(self.caster:GetIntellect()*(self.ability:GetSpecialValueFor("int_to_damage")/100))
