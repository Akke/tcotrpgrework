LinkLuaModifier("modifier_hero_akasha_sadist", "heroes/hero_akasha/sadist.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_hero_akasha_sadist_stacks", "heroes/hero_akasha/sadist.lua", LUA_MODIFIER_MOTION_NONE)
