LinkLuaModifier("modifier_sniper_take_aim_custom", "heroes/hero_sniper/sniper_take_aim_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sniper_take_aim_custom_casting", "heroes/hero_sniper/sniper_take_aim_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sniper_take_aim_custom_shield", "heroes/hero_sniper/sniper_take_aim_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sniper_take_aim_custom_crosshair", "heroes/hero_sniper/sniper_take_aim_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sniper_take_aim_custom_scepter_buff", "heroes/hero_sniper/sniper_take_aim_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sniper_take_aim_custom_scepter_cd", "heroes/hero_sniper/sniper_take_aim_custom.lua", LUA_MODIFIER_MOTION_NONE)
