LinkLuaModifier("modifier_sniper_long_range_advantage_custom", "heroes/hero_sniper/sniper_long_range_advantage_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sniper_long_range_advantage_custom_buff", "heroes/hero_sniper/sniper_long_range_advantage_custom.lua", LUA_MODIFIER_MOTION_NONE)
