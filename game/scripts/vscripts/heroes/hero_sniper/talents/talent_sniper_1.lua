LinkLuaModifier("modifier_talent_sniper_1", "heroes/hero_sniper/talents/talent_sniper_1.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_talent_sniper_1_overheat", "heroes/hero_sniper/talents/talent_sniper_1.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_talent_sniper_1_superheat", "heroes/hero_sniper/talents/talent_sniper_1.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_talent_sniper_1_ignite", "heroes/hero_sniper/talents/talent_sniper_1.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_talent_sniper_1_activated", "heroes/hero_sniper/talents/talent_sniper_1.lua", LUA_MODIFIER_MOTION_NONE)
