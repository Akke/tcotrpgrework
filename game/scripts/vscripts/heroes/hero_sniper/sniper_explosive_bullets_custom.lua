LinkLuaModifier("modifier_sniper_explosive_bullets_custom", "heroes/hero_sniper/sniper_explosive_bullets_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sniper_explosive_bullets_custom_scepter_buff", "heroes/hero_sniper/sniper_explosive_bullets_custom.lua", LUA_MODIFIER_MOTION_NONE)
