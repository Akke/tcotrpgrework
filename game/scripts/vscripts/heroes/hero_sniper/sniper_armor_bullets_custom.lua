LinkLuaModifier("modifier_sniper_armor_bullets_custom", "heroes/hero_sniper/sniper_armor_bullets_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sniper_armor_bullets_custom_active", "heroes/hero_sniper/sniper_armor_bullets_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sniper_armor_bullets_custom_debuff", "heroes/hero_sniper/sniper_armor_bullets_custom.lua", LUA_MODIFIER_MOTION_NONE)
