...
LinkLuaModifier( "modifier_sniper_shrapnel_custom", "heroes/hero_sniper/sniper_shrapnel_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_sniper_shrapnel_custom_debuff", "heroes/hero_sniper/sniper_shrapnel_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_sniper_shrapnel_custom_thinker", "heroes/hero_sniper/sniper_shrapnel_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_sniper_shrapnel_custom_def", "heroes/hero_sniper/sniper_shrapnel_custom.lua", LUA_MODIFIER_MOTION_NONE )
