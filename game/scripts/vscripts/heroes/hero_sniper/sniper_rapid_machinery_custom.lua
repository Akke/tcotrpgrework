LinkLuaModifier("modifier_sniper_rapid_machinery_custom", "heroes/hero_sniper/sniper_rapid_machinery_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sniper_rapid_machinery_custom_buff", "heroes/hero_sniper/sniper_rapid_machinery_custom.lua", LUA_MODIFIER_MOTION_NONE)
