LinkLuaModifier("modifier_drow_ranger_camouflage", "heroes/hero_drow_ranger/drow_ranger_camouflage.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_camouflage_buff", "heroes/hero_drow_ranger/drow_ranger_camouflage.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_camouflage_debuff", "heroes/hero_drow_ranger/drow_ranger_camouflage.lua", LUA_MODIFIER_MOTION_NONE)
