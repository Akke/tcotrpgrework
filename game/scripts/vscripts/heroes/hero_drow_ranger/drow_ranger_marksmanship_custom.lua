LinkLuaModifier("modifier_drow_ranger_marksmanship_custom", "heroes/hero_drow_ranger/drow_ranger_marksmanship_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_marksmanship_custom_debuff", "heroes/hero_drow_ranger/drow_ranger_marksmanship_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_marksmanship_custom_aura", "heroes/hero_drow_ranger/drow_ranger_marksmanship_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_marksmanship_custom_aura_crit", "heroes/hero_drow_ranger/drow_ranger_marksmanship_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier( "modifier_drow_ranger_multishot_custom", "heroes/hero_drow_ranger/drow_ranger_multishot_custom.lua", LUA_MODIFIER_MOTION_NONE )
