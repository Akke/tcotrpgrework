LinkLuaModifier("modifier_talent_drow_ranger_2", "heroes/hero_drow_ranger/talents/talent_drow_ranger_2.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_talent_drow_ranger_2_damage_buff", "heroes/hero_drow_ranger/talents/talent_drow_ranger_2.lua", LUA_MODIFIER_MOTION_NONE)
