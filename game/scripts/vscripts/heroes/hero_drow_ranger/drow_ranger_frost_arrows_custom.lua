LinkLuaModifier("modifier_drow_ranger_frost_arrows_custom", "heroes/hero_drow_ranger/drow_ranger_frost_arrows_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_frost_arrows_custom_debuff", "heroes/hero_drow_ranger/drow_ranger_frost_arrows_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_frost_arrows_custom_hypothermia_debuff", "heroes/hero_drow_ranger/drow_ranger_frost_arrows_custom.lua", LUA_MODIFIER_MOTION_NONE)
