LinkLuaModifier("modifier_drow_ranger_glacier_custom", "heroes/hero_drow_ranger/drow_ranger_glacier_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_glacier_custom_aura", "heroes/hero_drow_ranger/drow_ranger_glacier_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_glacier_custom_emitter", "heroes/hero_drow_ranger/drow_ranger_glacier_custom.lua", LUA_MODIFIER_MOTION_NONE)
