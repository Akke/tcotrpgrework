LinkLuaModifier("modifier_drow_ranger_archery_custom", "heroes/hero_drow_ranger/drow_ranger_archery_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_drow_ranger_archery_custom_aura", "heroes/hero_drow_ranger/drow_ranger_archery_custom.lua", LUA_MODIFIER_MOTION_NONE)
