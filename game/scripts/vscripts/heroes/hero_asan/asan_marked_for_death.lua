LinkLuaModifier("modifier_asan_marked_for_death", "heroes/hero_asan/asan_marked_for_death.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_asan_marked_for_death_debuff", "heroes/hero_asan/asan_marked_for_death.lua", LUA_MODIFIER_MOTION_NONE)
