LinkLuaModifier("modifier_asan_into_veil", "heroes/hero_asan/asan_into_veil.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_asan_into_veil_buff", "heroes/hero_asan/asan_into_veil.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_asan_into_veil_aura_enemy", "heroes/hero_asan/asan_into_veil.lua", LUA_MODIFIER_MOTION_NONE)
