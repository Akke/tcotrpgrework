LinkLuaModifier("modifier_asan_sword_mastery", "heroes/hero_asan/asan_sword_mastery.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_asan_sword_mastery_charges", "heroes/hero_asan/asan_sword_mastery.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_asan_sword_mastery_effect", "heroes/hero_asan/asan_sword_mastery.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_asan_sword_mastery_scepter", "heroes/hero_asan/asan_sword_mastery.lua", LUA_MODIFIER_MOTION_NONE)
