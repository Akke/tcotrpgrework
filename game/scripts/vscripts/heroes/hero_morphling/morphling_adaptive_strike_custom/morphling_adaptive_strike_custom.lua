LinkLuaModifier("modifier_morphling_adaptive_strike_custom", "heroes/hero_morphling/morphling_adaptive_strike_custom/morphling_adaptive_strike_custom.lua", LUA_MODIFIER_MOTION_NONE)
