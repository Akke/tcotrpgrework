LinkLuaModifier("modifier_faceless_void_temporal_reversion_custom", "heroes/hero_faceless_void/faceless_void_temporal_reversion_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_faceless_void_temporal_reversion_custom_debuff", "heroes/hero_faceless_void/faceless_void_temporal_reversion_custom.lua", LUA_MODIFIER_MOTION_NONE)
