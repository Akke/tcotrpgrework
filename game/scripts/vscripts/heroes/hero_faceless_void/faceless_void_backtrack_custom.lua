LinkLuaModifier("modifier_faceless_void_backtrack_custom", "heroes/hero_faceless_void/faceless_void_backtrack_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_faceless_void_backtrack_custom_buff", "heroes/hero_faceless_void/faceless_void_backtrack_custom.lua", LUA_MODIFIER_MOTION_NONE)
