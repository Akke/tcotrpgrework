...
LinkLuaModifier( "modifier_ogre_magi_fireblast_custom", "heroes/hero_ogre_magi/ogre_magi_fireblast_custom.lua", LUA_MODIFIER_MOTION_NONE )
...
function ogre_magi_fireblast_custom:OnSpellStart()
    ...
    local damage = self:GetSpecialValueFor( "fireblast_damage" ) + (self:GetCaster():GetIntellect()*(self:GetSpecialValueFor("int_to_damage")/100))
