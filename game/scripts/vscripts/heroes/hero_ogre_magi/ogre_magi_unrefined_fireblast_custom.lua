...
LinkLuaModifier( "modifier_ogre_magi_unrefined_fireblast_custom", "heroes/hero_ogre_magi/ogre_magi_unrefined_fireblast_custom.lua", LUA_MODIFIER_MOTION_NONE )
...
function modifier_ogre_magi_unrefined_fireblast_custom:OnAttack(event)
    ...
    local damage = mana + ability:GetSpecialValueFor( "fireblast_damage" ) + (caster:GetIntellect()*(ability:GetSpecialValueFor("int_to_damage")/100))
...
function ogre_magi_unrefined_fireblast_custom:OnSpellStart()
    ...
    local damage = mana + self:GetSpecialValueFor( "fireblast_damage" ) + (self:GetCaster():GetIntellect()*(self:GetSpecialValueFor("int_to_damage")/100))
