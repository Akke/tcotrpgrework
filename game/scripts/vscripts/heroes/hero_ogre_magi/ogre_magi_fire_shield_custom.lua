LinkLuaModifier("modifier_ogre_magi_fire_shield_custom", "heroes/hero_ogre_magi/ogre_magi_fire_shield_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ogre_magi_fire_shield_custom_absorb_state", "heroes/hero_ogre_magi/ogre_magi_fire_shield_custom.lua", LUA_MODIFIER_MOTION_NONE)
