...
LinkLuaModifier( "modifier_ogre_magi_bloodlust_custom", "heroes/hero_ogre_magi/ogre_magi_bloodlust_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_ogre_magi_bloodlust_custom_buff", "heroes/hero_ogre_magi/ogre_magi_bloodlust_custom.lua", LUA_MODIFIER_MOTION_NONE )
