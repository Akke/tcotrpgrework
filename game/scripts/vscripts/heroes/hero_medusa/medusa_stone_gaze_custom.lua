LinkLuaModifier("modifier_medusa_stone_gaze_custom", "heroes/hero_medusa/medusa_stone_gaze_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_medusa_stone_gaze_custom_slow", "heroes/hero_medusa/medusa_stone_gaze_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_medusa_stone_gaze_custom_stone", "heroes/hero_medusa/medusa_stone_gaze_custom.lua", LUA_MODIFIER_MOTION_NONE)
