...
LinkLuaModifier( "modifier_medusa_mana_shield_custom", "heroes/hero_medusa/medusa_mana_shield_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_medusa_mana_shield_custom_mana", "heroes/hero_medusa/medusa_mana_shield_custom.lua", LUA_MODIFIER_MOTION_NONE )
