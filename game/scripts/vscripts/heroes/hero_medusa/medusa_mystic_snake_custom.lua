LinkLuaModifier("modifier_mystic_snake_custom", "heroes/hero_medusa/medusa_mystic_snake_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_mystic_snake_custom_petrify_cd", "heroes/hero_medusa/medusa_mystic_snake_custom.lua", LUA_MODIFIER_MOTION_NONE)
