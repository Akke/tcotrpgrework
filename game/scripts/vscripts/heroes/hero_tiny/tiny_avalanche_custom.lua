LinkLuaModifier("modifier_tiny_avalanche_custom", "heroes/hero_tiny/tiny_avalanche_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_tiny_avalanche_custom_thinker", "heroes/hero_tiny/tiny_avalanche_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_tiny_avalanche_custom_debuff", "heroes/hero_tiny/tiny_avalanche_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_tiny_avalanche_custom_slow", "heroes/hero_tiny/tiny_avalanche_custom.lua", LUA_MODIFIER_MOTION_NONE)
