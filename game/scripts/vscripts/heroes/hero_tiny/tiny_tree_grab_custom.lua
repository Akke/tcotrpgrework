-- Credits goes to the Dota IMBA team https://github.com/EarthSalamander42/dota_imba/blob/master/game/scripts/vscripts/components/abilities/heroes/hero_tiny.lua
LinkLuaModifier("modifier_tiny_tree_grab_custom", "heroes/hero_tiny/tiny_tree_grab_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_tiny_tree_grab_custom_tree", "heroes/hero_tiny/tiny_tree_grab_custom.lua", LUA_MODIFIER_MOTION_NONE)
