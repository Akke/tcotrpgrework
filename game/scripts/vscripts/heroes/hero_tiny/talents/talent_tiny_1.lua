LinkLuaModifier("modifier_talent_tiny_1", "heroes/hero_tiny/talents/talent_tiny_1.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_talent_tiny_1_debuff", "heroes/hero_tiny/talents/talent_tiny_1.lua", LUA_MODIFIER_MOTION_NONE)
