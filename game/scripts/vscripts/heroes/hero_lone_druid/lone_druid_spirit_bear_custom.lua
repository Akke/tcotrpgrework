LinkLuaModifier("modifier_lone_druid_spirit_bear_custom", "heroes/hero_lone_druid/lone_druid_spirit_bear_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lone_druid_spirit_bear_custom_thinker", "heroes/hero_lone_druid/lone_druid_spirit_bear_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lone_druid_spirit_bear_custom_disarmed", "heroes/hero_lone_druid/lone_druid_spirit_bear_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_movement_speed_uba", "modifiers/modifier_movement_speed_uba.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lone_druid_spirit_link_custom_bear", "heroes/hero_lone_druid/lone_druid_spirit_link_custom.lua", LUA_MODIFIER_MOTION_NONE)
