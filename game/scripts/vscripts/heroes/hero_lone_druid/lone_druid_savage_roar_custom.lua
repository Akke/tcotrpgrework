LinkLuaModifier("modifier_lone_druid_savage_roar_custom", "heroes/hero_lone_druid/lone_druid_savage_roar_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lone_druid_savage_roar_custom_autocast", "heroes/hero_lone_druid/lone_druid_savage_roar_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lone_druid_savage_roar_custom_buff", "heroes/hero_lone_druid/lone_druid_savage_roar_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lone_druid_savage_roar_custom_debuff", "heroes/hero_lone_druid/lone_druid_savage_roar_custom.lua", LUA_MODIFIER_MOTION_NONE)
