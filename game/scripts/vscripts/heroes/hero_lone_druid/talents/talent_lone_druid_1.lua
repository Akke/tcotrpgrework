...
-- https://github.com/EarthSalamander42/dota_imba/blob/master/game/scripts/vscripts/components/items/item_meteor_hammer.lua
LinkLuaModifier("modifier_talent_lone_druid_1", "heroes/hero_lone_druid/talents/talent_lone_druid_1.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_talent_lone_druid_1:OnAttack(event)
    ...
    local damage = parent:GetIntellect() * (ability:GetSpecialValueFor("int_to_damage")/100)
