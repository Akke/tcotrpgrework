LinkLuaModifier("modifier_lone_druid_true_form_custom", "heroes/hero_lone_druid/lone_druid_true_form_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lone_druid_true_form_custom_transforming", "heroes/hero_lone_druid/lone_druid_true_form_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lone_druid_true_form_custom_talent_thinker", "heroes/hero_lone_druid/lone_druid_true_form_custom.lua", LUA_MODIFIER_MOTION_NONE)
