LinkLuaModifier("modifier_doom_infernal_servant", "heroes/hero_doom/doom_infernal_servant.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_doom_infernal_servant_thinker", "heroes/hero_doom/doom_infernal_servant.lua", LUA_MODIFIER_MOTION_NONE)
