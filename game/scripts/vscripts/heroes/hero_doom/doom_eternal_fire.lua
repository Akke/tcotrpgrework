...
LinkLuaModifier( "modifier_doom_eternal_fire", "heroes/hero_doom/doom_eternal_fire.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_doom_eternal_fire_thinker", "heroes/hero_doom/doom_eternal_fire.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_doom_eternal_fire_damage_thinker", "heroes/hero_doom/doom_eternal_fire.lua", LUA_MODIFIER_MOTION_NONE )
