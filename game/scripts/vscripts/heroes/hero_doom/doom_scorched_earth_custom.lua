...
LinkLuaModifier( "modifier_doom_scorched_earth_custom", "heroes/hero_doom/doom_scorched_earth_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_doom_scorched_earth_custom_auto", "heroes/hero_doom/doom_scorched_earth_custom.lua", LUA_MODIFIER_MOTION_NONE )
