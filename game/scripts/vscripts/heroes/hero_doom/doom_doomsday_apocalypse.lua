LinkLuaModifier("modifier_doom_doomsday_apocalypse", "heroes/hero_doom/doom_doomsday_apocalypse.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_doom_doomsday_apocalypse_emitter", "heroes/hero_doom/doom_doomsday_apocalypse.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_doom_doomsday_apocalypse_emitter_aura", "heroes/hero_doom/doom_doomsday_apocalypse.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_doom_doomsday_apocalypse_emitter_aura_friendly", "heroes/hero_doom/doom_doomsday_apocalypse.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_doom_doomsday_apocalypse_soul_stacks", "heroes/hero_doom/doom_doomsday_apocalypse.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_doom_doomsday_apocalypse_emitter_aura:OnIntervalThink()
    ...
    if not parent:IsMagicImmune() and not parent:IsInvulnerable() then
        ApplyDamage({
            victim = parent,
            attacker = caster,
            damage = (self.damage + (caster:GetIntellect() * (self.strToDamage/100))) * self.interval,
