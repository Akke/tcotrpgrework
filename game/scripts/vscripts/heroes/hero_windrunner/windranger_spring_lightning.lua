...
function modifier_windranger_spring_lightning:OnAttack(event)
    ...
    self.damage = (self.ability:GetSpecialValueFor("damage") + (caster:GetIntellect() * (self.ability:GetSpecialValueFor("int_to_damage")/100))) * (1+(multiplier * (self.ability:GetSpecialValueFor("buff_dmg_increase_pct")/100)))
