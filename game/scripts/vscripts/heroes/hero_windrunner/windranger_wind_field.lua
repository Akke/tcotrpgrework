LinkLuaModifier("modifier_windranger_wind_field", "heroes/hero_windrunner/windranger_wind_field.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_windranger_wind_field_emitter", "heroes/hero_windrunner/windranger_wind_field.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_windranger_wind_field_emitter_aura", "heroes/hero_windrunner/windranger_wind_field.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_windranger_wind_field_emitter_aura_ally", "heroes/hero_windrunner/windranger_wind_field.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_windranger_wind_field_emitter:OnIntervalThink()
    ...
    local damage = (self.damage + (caster:GetIntellect() * (self.intToDamage/100))) * self.multiplier * self.interval
