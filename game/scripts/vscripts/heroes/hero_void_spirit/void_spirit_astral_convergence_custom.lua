LinkLuaModifier("modifier_void_spirit_astral_convergence_custom", "heroes/hero_void_spirit/void_spirit_astral_convergence_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_void_spirit_astral_convergence_custom_caster", "heroes/hero_void_spirit/void_spirit_astral_convergence_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_void_spirit_astral_convergence_custom_debuff", "heroes/hero_void_spirit/void_spirit_astral_convergence_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_void_spirit_astral_convergence_custom_emitter", "heroes/hero_void_spirit/void_spirit_astral_convergence_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_void_spirit_astral_convergence_custom_caster:DoAstralStep()
    ...
    local pop_damage = ability:GetSpecialValueFor( "pop_damage" ) + (caster:GetIntellect() * (ability:GetSpecialValueFor("int_to_damage")/100))
...
function modifier_void_spirit_astral_convergence_custom_debuff:OnCreated( kv )
    ...
    local caster = self:GetCaster()
    local ability = self:GetAbility()
    self.damage = self:GetAbility():GetSpecialValueFor( "pop_damage" ) + (caster:GetIntellect() * (ability:GetSpecialValueFor("int_to_damage")/100))
