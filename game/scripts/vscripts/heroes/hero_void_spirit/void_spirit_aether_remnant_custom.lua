LinkLuaModifier("modifier_void_spirit_aether_remnant_custom", "heroes/hero_void_spirit/void_spirit_aether_remnant_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_void_spirit_aether_remnant_custom_emitter", "heroes/hero_void_spirit/void_spirit_aether_remnant_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_void_spirit_aether_remnant_custom_emitter_aura", "heroes/hero_void_spirit/void_spirit_aether_remnant_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_void_spirit_aether_remnant_custom_buff", "heroes/hero_void_spirit/void_spirit_aether_remnant_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_void_spirit_aether_remnant_custom_emitter:OnCreated(params)
    ...
    self.intellect = caster:GetIntellect() - parent:GetIntellect()
...
function modifier_void_spirit_aether_remnant_custom_emitter_aura:OnCreated()
    ...
    self.damageTable = {
        ...
        damage = (self:GetAbility():GetSpecialValueFor("damage") + (self:GetCaster():GetIntellect() * (self:GetAbility():GetSpecialValueFor("int_to_damage")/100))) * interval,
