...
LinkLuaModifier( "modifier_void_spirit_resonant_pulse_custom", "heroes/hero_void_spirit/void_spirit_resonant_pulse_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_void_spirit_resonant_pulse_custom_debuff", "heroes/hero_void_spirit/void_spirit_resonant_pulse_custom.lua", LUA_MODIFIER_MOTION_NONE )
...
function modifier_void_spirit_resonant_pulse_custom:OnCreated( kv )
    ...
    self.damageTable = {
        ...
        damage = self.damage + (self:GetParent():GetIntellect() * (self:GetAbility():GetSpecialValueFor("int_to_damage")/100)),
