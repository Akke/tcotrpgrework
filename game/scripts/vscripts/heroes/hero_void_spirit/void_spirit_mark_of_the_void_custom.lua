LinkLuaModifier("modifier_void_spirit_mark_of_the_void_custom", "heroes/hero_void_spirit/void_spirit_mark_of_the_void_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_void_spirit_mark_of_the_void_custom_debuff", "heroes/hero_void_spirit/void_spirit_mark_of_the_void_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_void_spirit_mark_of_the_void_custom_scepter_buff", "heroes/hero_void_spirit/void_spirit_mark_of_the_void_custom.lua", LUA_MODIFIER_MOTION_NONE)
