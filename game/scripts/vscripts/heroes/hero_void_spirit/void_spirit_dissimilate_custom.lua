LinkLuaModifier("modifier_void_spirit_dissimilate_custom", "heroes/hero_void_spirit/void_spirit_dissimilate_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_void_spirit_dissimilate_custom_aura", "heroes/hero_void_spirit/void_spirit_dissimilate_custom.lua", LUA_MODIFIER_MOTION_NONE)
