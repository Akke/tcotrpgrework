LinkLuaModifier("modifier_weaver_shukuchi_custom", "heroes/hero_weaver/weaver_shukuchi_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_weaver_shukuchi_custom_aura", "heroes/hero_weaver/weaver_shukuchi_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_weaver_shukuchi_custom_illusion", "heroes/hero_weaver/weaver_shukuchi_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_weaver_shukuchi_custom_scepter_debuff", "heroes/hero_weaver/weaver_shukuchi_custom.lua", LUA_MODIFIER_MOTION_NONE)
