LinkLuaModifier("modifier_weaver_geminate_attack_custom", "heroes/hero_weaver/weaver_geminate_attack_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_weaver_geminate_attack_custom_extra_attack", "heroes/hero_weaver/weaver_geminate_attack_custom.lua", LUA_MODIFIER_MOTION_NONE)
