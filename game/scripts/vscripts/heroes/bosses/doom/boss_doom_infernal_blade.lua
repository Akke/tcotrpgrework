LinkLuaModifier("modifier_boss_doom_infernal_blade", "heroes/bosses/doom/boss_doom_infernal_blade.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_doom_infernal_blade_debuff", "heroes/bosses/doom/boss_doom_infernal_blade.lua", LUA_MODIFIER_MOTION_NONE)
