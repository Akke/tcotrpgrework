LinkLuaModifier("modifier_boss_doom_doom_aura", "heroes/bosses/doom/boss_doom_doom_aura.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_doom_doom_aura_debuff", "heroes/bosses/doom/boss_doom_doom_aura.lua", LUA_MODIFIER_MOTION_NONE)
