LinkLuaModifier("modifier_boss_doom_devour", "heroes/bosses/doom/boss_doom_devour.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_doom_devour_buff", "heroes/bosses/doom/boss_doom_devour.lua", LUA_MODIFIER_MOTION_NONE)
