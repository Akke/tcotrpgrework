...
LinkLuaModifier( "modifier_enchantress_untouchable_custom", "heroes/bosses/secret/enchantress/enchantress_untouchable_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_enchantress_untouchable_custom_debuff", "heroes/bosses/secret/enchantress/enchantress_untouchable_custom.lua", LUA_MODIFIER_MOTION_NONE )
