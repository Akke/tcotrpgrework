LinkLuaModifier("boss_queen_of_pain_berserk_modifier", "heroes/bosses/akasha/berserk.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_queen_of_pain_berserk_modifier_buff", "heroes/bosses/akasha/berserk.lua", LUA_MODIFIER_MOTION_NONE)
