LinkLuaModifier("boss_queen_of_pain_sonic_wave_modifier", "heroes/bosses/akasha/sonic_wave.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_queen_of_pain_sonic_wave_thinker", "heroes/bosses/akasha/sonic_wave.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_queen_of_pain_sonic_wave_thinker_animation", "heroes/bosses/akasha/sonic_wave.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_queen_of_pain_sonic_wave_debuff", "heroes/bosses/akasha/sonic_wave.lua", LUA_MODIFIER_MOTION_NONE)
