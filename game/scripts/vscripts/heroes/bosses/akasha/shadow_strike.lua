LinkLuaModifier("boss_queen_of_pain_shadow_strike_modifier", "heroes/bosses/akasha/shadow_strike.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_queen_of_pain_shadow_strike_modifier_debuff", "heroes/bosses/akasha/shadow_strike.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_queen_of_pain_shadow_strike_modifier_damage_debuff", "heroes/bosses/akasha/shadow_strike.lua", LUA_MODIFIER_MOTION_NONE)
