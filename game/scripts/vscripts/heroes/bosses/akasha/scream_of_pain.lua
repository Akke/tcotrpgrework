LinkLuaModifier("boss_queen_of_pain_scream_of_pain_modifier", "heroes/bosses/akasha/scream_of_pain.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_queen_of_pain_scream_of_pain_modifier_debuff", "heroes/bosses/akasha/scream_of_pain.lua", LUA_MODIFIER_MOTION_NONE)
