LinkLuaModifier("boss_mid_defense", "heroes/bosses/akasha/boss_mid_defense.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_mid_defense_modifier", "heroes/bosses/akasha/boss_mid_defense.lua", LUA_MODIFIER_MOTION_NONE)
