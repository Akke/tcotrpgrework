...
function boss_queen_of_pain_ai:OnDeath(event)
    ...
    Timers:CreateTimer(BOSS_RESPAWN_INTERVAL, function ()
        boss_queen_of_pain:Spawn(BOSS_NAME)
    end)
    ...
    GameRules:SendCustomMessage("<font color='yellow'>Akasha, the Queen of Pain was defeated.</font>", 0, 0)
