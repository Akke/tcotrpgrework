LinkLuaModifier("modifier_keymaster_font_overwhelming", "heroes/bosses/keymaster/keymaster_font_overwhelming.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_keymaster_font_overwhelming_aura", "heroes/bosses/keymaster/keymaster_font_overwhelming.lua", LUA_MODIFIER_MOTION_NONE)
