LinkLuaModifier("modifier_keymaster_borrowed_time", "heroes/bosses/keymaster/keymaster_borrowed_time.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_keymaster_borrowed_time_buff", "heroes/bosses/keymaster/keymaster_borrowed_time.lua", LUA_MODIFIER_MOTION_NONE)
