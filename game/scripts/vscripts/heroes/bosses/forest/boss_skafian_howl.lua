LinkLuaModifier("modifier_boss_skafian_howl", "heroes/bosses/forest/boss_skafian_howl.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_skafian_howl_buff", "heroes/bosses/forest/boss_skafian_howl.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_skafian_howl_stunned", "heroes/bosses/forest/boss_skafian_howl.lua", LUA_MODIFIER_MOTION_NONE)
