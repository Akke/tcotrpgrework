LinkLuaModifier("modifier_boss_skafian_lycanthropy", "heroes/bosses/forest/boss_skafian_lycanthropy.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_skafian_lycanthropy_buff", "heroes/bosses/forest/boss_skafian_lycanthropy.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_skafian_lycanthropy_wolf_ai", "heroes/bosses/forest/boss_skafian_lycanthropy.lua", LUA_MODIFIER_MOTION_NONE)
