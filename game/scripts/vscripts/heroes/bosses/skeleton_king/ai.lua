LinkLuaModifier("boss_skeleton_king_ai", "heroes/bosses/skeleton_king/ai.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_skeleton_king_ai_unstunnable", "heroes/bosses/skeleton_king/ai.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_skeleton_king_ai_frozen", "heroes/bosses/skeleton_king/ai.lua", LUA_MODIFIER_MOTION_NONE)
