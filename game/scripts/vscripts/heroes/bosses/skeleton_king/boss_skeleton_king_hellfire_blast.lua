LinkLuaModifier("boss_skeleton_king_hellfire_blast_modifier", "heroes/bosses/skeleton_king/boss_skeleton_king_hellfire_blast.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_skeleton_king_hellfire_blast_modifier_debuff", "heroes/bosses/skeleton_king/boss_skeleton_king_hellfire_blast.lua", LUA_MODIFIER_MOTION_NONE)
