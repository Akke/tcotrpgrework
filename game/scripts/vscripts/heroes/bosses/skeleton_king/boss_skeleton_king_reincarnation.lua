LinkLuaModifier("boss_skeleton_king_reincarnation_modifier", "heroes/bosses/skeleton_king/boss_skeleton_king_reincarnation.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_skeleton_king_reincarnation_modifier_debuff", "heroes/bosses/skeleton_king/boss_skeleton_king_reincarnation.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_skeleton_king_reincarnation_modifier_reincarnating", "heroes/bosses/skeleton_king/boss_skeleton_king_reincarnation.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_skeleton_king_reincarnation_modifier_dr_buff", "heroes/bosses/skeleton_king/boss_skeleton_king_reincarnation.lua", LUA_MODIFIER_MOTION_NONE)
