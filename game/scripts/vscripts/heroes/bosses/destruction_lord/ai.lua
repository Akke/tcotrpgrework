LinkLuaModifier("boss_destruction_lord_ai", "heroes/bosses/destruction_lord/ai.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_destruction_lord_ai_frozen", "heroes/bosses/destruction_lord/ai.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("boss_destruction_lord_ai_tombstone", "heroes/bosses/destruction_lord/ai.lua", LUA_MODIFIER_MOTION_NONE)
