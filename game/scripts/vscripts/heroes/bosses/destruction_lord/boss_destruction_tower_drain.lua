...
LinkLuaModifier( "modifier_boss_destruction_tower_drain_thinker", "heroes/bosses/destruction_lord/boss_destruction_tower_drain.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_boss_destruction_tower_drain_debuff_thinker", "heroes/bosses/destruction_lord/boss_destruction_tower_drain.lua", LUA_MODIFIER_MOTION_NONE )
