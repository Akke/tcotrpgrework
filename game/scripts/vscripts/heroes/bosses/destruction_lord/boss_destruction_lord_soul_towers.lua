LinkLuaModifier("modifier_boss_destruction_lord_soul_towers", "heroes/bosses/destruction_lord/boss_destruction_lord_soul_towers.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_destruction_lord_soul_towers_tower", "heroes/bosses/destruction_lord/boss_destruction_lord_soul_towers.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_destruction_lord_soul_towers_boss_buff", "heroes/bosses/destruction_lord/boss_destruction_lord_soul_towers.lua", LUA_MODIFIER_MOTION_NONE)
