LinkLuaModifier("modifier_boss_destruction_lord_soul_slice", "heroes/bosses/destruction_lord/boss_destruction_lord_soul_slice.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_destruction_lord_soul_slice_debuff", "heroes/bosses/destruction_lord/boss_destruction_lord_soul_slice.lua", LUA_MODIFIER_MOTION_NONE)
