LinkLuaModifier("modifier_boss_spider_poison_bite", "heroes/bosses/spider/boss_spider_poison_bite.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_spider_poison_bite_debuff", "heroes/bosses/spider/boss_spider_poison_bite.lua", LUA_MODIFIER_MOTION_NONE)
