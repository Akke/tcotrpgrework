LinkLuaModifier("modifier_follower_spider_sandstorm", "heroes/bosses/spider/follower_spider_sandstorm.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_follower_spider_sandstorm_emitter", "heroes/bosses/spider/follower_spider_sandstorm.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_follower_spider_sandstorm_emitter_aura", "heroes/bosses/spider/follower_spider_sandstorm.lua", LUA_MODIFIER_MOTION_NONE)
