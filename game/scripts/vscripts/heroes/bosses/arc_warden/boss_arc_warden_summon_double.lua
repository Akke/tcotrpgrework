LinkLuaModifier("modifier_boss_arc_warden_summon_double", "heroes/bosses/arc_warden/boss_arc_warden_summon_double.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_arc_warden_summon_double_damage_reduction", "heroes/bosses/arc_warden/boss_arc_warden_summon_double.lua", LUA_MODIFIER_MOTION_NONE)
