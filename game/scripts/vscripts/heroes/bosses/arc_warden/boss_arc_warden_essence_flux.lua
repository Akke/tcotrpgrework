LinkLuaModifier("modifier_boss_arc_warden_essence_flux", "heroes/bosses/arc_warden/boss_arc_warden_essence_flux.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_arc_warden_essence_flux_aura", "heroes/bosses/arc_warden/boss_arc_warden_essence_flux.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_arc_warden_essence_flux_debuff", "heroes/bosses/arc_warden/boss_arc_warden_essence_flux.lua", LUA_MODIFIER_MOTION_NONE)
