LinkLuaModifier("modifier_boss_arc_warden_magnetic_field_collapse_thinker", "heroes/bosses/arc_warden/boss_arc_warden_magnetic_field_collapse.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_arc_warden_magnetic_field_collapse_thinker_aura", "heroes/bosses/arc_warden/boss_arc_warden_magnetic_field_collapse.lua", LUA_MODIFIER_MOTION_NONE)
