LinkLuaModifier("modifier_follower_reef_bleed", "heroes/bosses/winter/follower_reef_bleed.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_follower_reef_bleed_debuff", "heroes/bosses/winter/follower_reef_bleed.lua", LUA_MODIFIER_MOTION_NONE)
