LinkLuaModifier("modifier_follower_reef_slow", "heroes/bosses/winter/follower_reef_slow.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_follower_reef_slow_debuff", "heroes/bosses/winter/follower_reef_slow.lua", LUA_MODIFIER_MOTION_NONE)
