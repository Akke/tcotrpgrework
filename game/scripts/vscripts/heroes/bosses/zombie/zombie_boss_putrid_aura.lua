LinkLuaModifier("modifier_zombie_boss_putrid_aura", "heroes/bosses/zombie/zombie_boss_putrid_aura.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zombie_boss_putrid_aura_debuff", "heroes/bosses/zombie/zombie_boss_putrid_aura.lua", LUA_MODIFIER_MOTION_NONE)
