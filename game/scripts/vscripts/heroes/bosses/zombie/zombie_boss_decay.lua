LinkLuaModifier("modifier_zombie_boss_decay", "heroes/bosses/zombie/zombie_boss_decay.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zombie_boss_decay_debuff", "heroes/bosses/zombie/zombie_boss_decay.lua", LUA_MODIFIER_MOTION_NONE)
