LinkLuaModifier("modifier_zombie_boss_raise_dead", "heroes/bosses/zombie/zombie_boss_raise_dead.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zombie_boss_raise_dead_zombie_ai", "heroes/bosses/zombie/zombie_boss_raise_dead.lua", LUA_MODIFIER_MOTION_NONE)
