LinkLuaModifier("modifier_boss_dragon_mythical_hide", "heroes/bosses/dragon/boss_dragon_mythical_hide.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_boss_dragon_mythical_hide_buff", "heroes/bosses/dragon/boss_dragon_mythical_hide.lua", LUA_MODIFIER_MOTION_NONE)
