LinkLuaModifier("modifier_axe_berserkers_call_custom", "heroes/hero_axe/axe_berserkers_call_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_axe_berserkers_call_custom_active_buff", "heroes/hero_axe/axe_berserkers_call_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_axe_berserkers_call_custom_active_debuff", "heroes/hero_axe/axe_berserkers_call_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_axe_berserkers_call_custom_aura", "heroes/hero_axe/axe_berserkers_call_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_axe_berserkers_call_custom_aura_self", "heroes/hero_axe/axe_berserkers_call_custom.lua", LUA_MODIFIER_MOTION_NONE)
