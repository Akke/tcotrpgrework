LinkLuaModifier("modifier_axe_battle_hunger_custom", "heroes/hero_axe/axe_battle_hunger_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_axe_battle_hunger_custom_active_debuff", "heroes/hero_axe/axe_battle_hunger_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_axe_battle_hunger_custom_cooldown", "heroes/hero_axe/axe_battle_hunger_custom.lua", LUA_MODIFIER_MOTION_NONE)
