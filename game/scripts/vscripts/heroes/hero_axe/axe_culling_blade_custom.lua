...
LinkLuaModifier( "modifier_axe_culling_blade_custom", "heroes/hero_axe/axe_culling_blade_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_axe_culling_blade_custom_stacks", "heroes/hero_axe/axe_culling_blade_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_axe_culling_blade_custom_buff", "heroes/hero_axe/axe_culling_blade_custom.lua", LUA_MODIFIER_MOTION_NONE )
...
function modifier_axe_culling_blade_custom:OnAttackStart( params )
    if IsServer() then
        ...
        self.timer = Timers:CreateTimer(caster:GetSecondsPerAttack(), function()
            self.attack = true
            self.timer = nil
        end)
