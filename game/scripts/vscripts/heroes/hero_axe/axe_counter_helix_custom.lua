...
LinkLuaModifier( "modifier_axe_counter_helix_custom", "heroes/hero_axe/axe_counter_helix_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_axe_counter_helix_custom_toggle", "heroes/hero_axe/axe_counter_helix_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_axe_counter_helix_custom_thinker", "heroes/hero_axe/axe_counter_helix_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_axe_counter_helix_custom_thinker_aura", "heroes/hero_axe/axe_counter_helix_custom.lua", LUA_MODIFIER_MOTION_NONE )
