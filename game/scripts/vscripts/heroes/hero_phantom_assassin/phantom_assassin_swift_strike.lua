LinkLuaModifier("modifier_phantom_assassin_swift_strike", "heroes/hero_phantom_assassin/phantom_assassin_swift_strike.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_phantom_assassin_swift_strike_attack_buff", "heroes/hero_phantom_assassin/phantom_assassin_swift_strike.lua", LUA_MODIFIER_MOTION_NONE)
