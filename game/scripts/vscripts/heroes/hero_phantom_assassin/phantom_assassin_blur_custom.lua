LinkLuaModifier("modifier_phantom_assassin_blur_custom", "heroes/hero_phantom_assassin/phantom_assassin_blur_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_phantom_assassin_blur_custom_buff", "heroes/hero_phantom_assassin/phantom_assassin_blur_custom.lua", LUA_MODIFIER_MOTION_NONE)
