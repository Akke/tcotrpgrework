LinkLuaModifier("modifier_phantom_assassin_despair", "heroes/hero_phantom_assassin/phantom_assassin_despair.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_phantom_assassin_despair_active", "heroes/hero_phantom_assassin/phantom_assassin_despair.lua", LUA_MODIFIER_MOTION_NONE)
