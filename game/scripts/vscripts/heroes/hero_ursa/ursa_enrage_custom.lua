LinkLuaModifier("modifier_ursa_enrage_custom", "heroes/hero_ursa/ursa_enrage_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ursa_enrage_custom_buff", "heroes/hero_ursa/ursa_enrage_custom.lua", LUA_MODIFIER_MOTION_NONE)
