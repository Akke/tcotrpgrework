LinkLuaModifier("modifier_ursa_earthshock_custom", "heroes/hero_ursa/ursa_earthshock_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ursa_earthshock_custom_debuff", "heroes/hero_ursa/ursa_earthshock_custom.lua", LUA_MODIFIER_MOTION_NONE)
