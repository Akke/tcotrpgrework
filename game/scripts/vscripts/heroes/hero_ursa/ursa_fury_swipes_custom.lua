LinkLuaModifier("modifier_ursa_fury_swipes_custom", "heroes/hero_ursa/ursa_fury_swipes_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ursa_fury_swipes_custom_stack", "heroes/hero_ursa/ursa_fury_swipes_custom.lua", LUA_MODIFIER_MOTION_NONE)
