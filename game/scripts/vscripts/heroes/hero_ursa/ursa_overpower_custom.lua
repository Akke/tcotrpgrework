LinkLuaModifier("modifier_ursa_overpower_custom", "heroes/hero_ursa/ursa_overpower_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_ursa_overpower_custom_buff", "heroes/hero_ursa/ursa_overpower_custom.lua", LUA_MODIFIER_MOTION_NONE)
