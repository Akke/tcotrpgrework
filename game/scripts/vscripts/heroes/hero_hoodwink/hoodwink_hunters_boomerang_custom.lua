LinkLuaModifier("modifier_hoodwink_hunters_boomerang_custom", "heroes/hero_hoodwink/hoodwink_hunters_boomerang_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_hoodwink_hunters_boomerang_custom_throwing", "heroes/hero_hoodwink/hoodwink_hunters_boomerang_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_hoodwink_hunters_boomerang_custom_invulnerable", "heroes/hero_hoodwink/hoodwink_hunters_boomerang_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_hoodwink_hunters_boomerang_custom_debuff", "heroes/hero_hoodwink/hoodwink_hunters_boomerang_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_hoodwink_hunters_boomerang_custom_throwing:OnCreated(params)
    ...
    self.cast_range = (caster:GetAbsOrigin()-victim:GetAbsOrigin()):Length2D()
    ...
    ParticleManager:SetParticleControlEnt( self.nFXIndex, 0, self.hBoomerang, PATTACH_ABSORIGIN_FOLLOW, nil, self.hBoomerang:GetAbsOrigin(), true )
    ParticleManager:SetParticleControlEnt( self.nFXIndex, 1, self.hBoomerang, PATTACH_ABSORIGIN_FOLLOW, nil, self.hBoomerang:GetAbsOrigin(), true )
...
function modifier_hoodwink_hunters_boomerang_custom_throwing:OnIntervalThink()
    ...
    local rotation_gain = self.speed * 0.001
    ...
    if axe.retreat == true then
        ...
        if (axe:GetAbsOrigin() - caster:GetAbsOrigin()):Length2D() <= self.radius then
