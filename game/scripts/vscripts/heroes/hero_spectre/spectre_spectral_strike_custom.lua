LinkLuaModifier("modifier_spectre_spectral_strike_custom", "heroes/hero_spectre/spectre_spectral_strike_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_spectre_spectral_strike_custom_crit", "heroes/hero_spectre/spectre_spectral_strike_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_spectre_spectral_strike_custom_debuff", "heroes/hero_spectre/spectre_spectral_strike_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_spectre_spectral_strike_custom_fear", "heroes/hero_spectre/spectre_spectral_strike_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_spectre_spectral_strike_custom_counter", "heroes/hero_spectre/spectre_spectral_strike_custom.lua", LUA_MODIFIER_MOTION_NONE)
