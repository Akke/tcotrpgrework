LinkLuaModifier("modifier_talent_spectre_2", "heroes/hero_spectre/talents/talent_spectre_2.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_talent_spectre_2_spectral_dagger_cooldown", "heroes/hero_spectre/talents/talent_spectre_2.lua", LUA_MODIFIER_MOTION_NONE)
