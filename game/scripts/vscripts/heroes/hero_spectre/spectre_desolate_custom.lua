LinkLuaModifier("modifier_spectre_desolate_custom", "heroes/hero_spectre/spectre_desolate_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_spectre_desolate_custom_debuff", "heroes/hero_spectre/spectre_desolate_custom.lua", LUA_MODIFIER_MOTION_NONE)
