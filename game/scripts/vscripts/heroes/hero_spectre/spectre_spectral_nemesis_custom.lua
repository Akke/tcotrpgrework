LinkLuaModifier("modifier_spectre_spectral_nemesis_custom", "heroes/hero_spectre/spectre_spectral_nemesis_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_spectre_spectral_nemesis_custom_illusion", "heroes/hero_spectre/spectre_spectral_nemesis_custom.lua", LUA_MODIFIER_MOTION_NONE)
