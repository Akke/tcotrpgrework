LinkLuaModifier("modifier_spectre_spectral_dagger_custom", "heroes/hero_spectre/spectre_spectral_dagger_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_spectre_spectral_dagger_custom_debuff", "heroes/hero_spectre/spectre_spectral_dagger_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_spectre_spectral_dagger_custom_illusion", "heroes/hero_spectre/spectre_spectral_dagger_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_spectre_reality_custom_buff", "heroes/hero_spectre/spectre_reality_custom.lua", LUA_MODIFIER_MOTION_NONE)
