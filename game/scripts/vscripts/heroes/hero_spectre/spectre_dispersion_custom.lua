...
LinkLuaModifier( "modifier_spectre_dispersion_custom", "heroes/hero_spectre/spectre_dispersion_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_spectre_dispersion_custom_activated", "heroes/hero_spectre/spectre_dispersion_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_spectre_dispersion_custom_debuff", "heroes/hero_spectre/spectre_dispersion_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_spectre_dispersion_custom_talent_buff", "heroes/hero_spectre/spectre_dispersion_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_spectre_dispersion_custom_talent_cooldown", "heroes/hero_spectre/spectre_dispersion_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_spectre_dispersion_custom_aura", "heroes/hero_spectre/spectre_dispersion_custom.lua", LUA_MODIFIER_MOTION_NONE )
