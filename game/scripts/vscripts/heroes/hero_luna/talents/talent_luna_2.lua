LinkLuaModifier("modifier_talent_luna_2", "heroes/hero_luna/talents/talent_luna_2.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_talent_luna_2_debuff", "heroes/hero_luna/talents/talent_luna_2.lua", LUA_MODIFIER_MOTION_NONE)
