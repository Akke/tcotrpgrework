LinkLuaModifier("modifier_luna_moon_beam_custom", "heroes/hero_luna/luna_moon_beam_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_luna_moon_beam_custom:OnIntervalThink()
    ...
    local chance = caster:GetIntellect() * ability:GetSpecialValueFor("int_point_chance_repeat")
