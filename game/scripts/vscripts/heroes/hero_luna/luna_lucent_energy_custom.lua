LinkLuaModifier("modifier_luna_lucent_energy_custom", "heroes/hero_luna/luna_lucent_energy_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_luna_lucent_energy_custom_debuff", "heroes/hero_luna/luna_lucent_energy_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_luna_lucent_energy_custom_autocast", "heroes/hero_luna/luna_lucent_energy_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_luna_lucent_energy_custom_debuff:OnIntervalThink()
    ...
    local damage = ability:GetSpecialValueFor("debuff_damage") + (caster:GetIntellect() * (ability:GetSpecialValueFor("int_to_damage")/100))
