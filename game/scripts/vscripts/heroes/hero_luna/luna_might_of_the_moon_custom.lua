LinkLuaModifier("modifier_luna_might_of_the_moon_custom", "heroes/hero_luna/luna_might_of_the_moon_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_luna_might_of_the_moon_custom_stacks", "heroes/hero_luna/luna_might_of_the_moon_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_luna_might_of_the_moon_custom_damage", "heroes/hero_luna/luna_might_of_the_moon_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_luna_might_of_the_moon_custom_sunstrike_pre", "heroes/hero_luna/luna_might_of_the_moon_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_luna_might_of_the_moon_custom_sunstrike_thinker", "heroes/hero_luna/luna_might_of_the_moon_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_luna_might_of_the_moon_custom_scepter", "heroes/hero_luna/luna_might_of_the_moon_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_luna_might_of_the_moon_custom_sunstrike_thinker:OnDestroy( kv )
    if IsServer() then
        ...
        local damageTable = {
            ...
            damage = self.damage + (self:GetCaster():GetIntellect() * (self:GetAbility():GetSpecialValueFor("int_to_damage")/100)),
