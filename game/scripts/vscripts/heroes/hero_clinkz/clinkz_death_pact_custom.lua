LinkLuaModifier("modifier_clinkz_death_pact_custom", "heroes/hero_clinkz/clinkz_death_pact_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_clinkz_death_pact_custom:OnRefresh()
    ...
    self.intellect = -(parent:GetIntellect() * (convert/100))
