LinkLuaModifier("modifier_clinkz_burning_spear_custom", "heroes/hero_clinkz/clinkz_burning_spear_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_clinkz_burning_spear_custom_casting", "heroes/hero_clinkz/clinkz_burning_spear_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_clinkz_burning_spear_custom_debuff", "heroes/hero_clinkz/clinkz_burning_spear_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_clinkz_burning_spear_custom_casting:OnCreated(params)
    ...
    if parent:HasModifier("modifier_item_aghanims_shard") then
        tInterval = parent:GetSecondsPerAttack()
