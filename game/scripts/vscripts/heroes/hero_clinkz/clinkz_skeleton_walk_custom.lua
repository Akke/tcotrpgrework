LinkLuaModifier("modifier_clinkz_skeleton_walk_custom", "heroes/hero_clinkz/clinkz_skeleton_walk_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_clinkz_skeleton_walk_custom_invis", "heroes/hero_clinkz/clinkz_skeleton_walk_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_clinkz_skeleton_archer_custom", "heroes/hero_clinkz/modifier_clinkz_skeleton_archer_custom.lua", LUA_MODIFIER_MOTION_NONE)
