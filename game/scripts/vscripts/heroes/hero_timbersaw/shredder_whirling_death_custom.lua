LinkLuaModifier("modifier_shredder_whirling_death_custom", "heroes/hero_timbersaw/shredder_whirling_death_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shredder_whirling_death_custom_debuff", "heroes/hero_timbersaw/shredder_whirling_death_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shredder_whirling_death_custom_buff", "heroes/hero_timbersaw/shredder_whirling_death_custom.lua", LUA_MODIFIER_MOTION_NONE)
