LinkLuaModifier("modifier_necrolyte_corpse_charges", "heroes/hero_necrolyte/necrolyte_corpse_charges.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_necrolyte_corpse_charges_buff_permanent", "heroes/hero_necrolyte/necrolyte_corpse_charges.lua", LUA_MODIFIER_MOTION_NONE)
