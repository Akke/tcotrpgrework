LinkLuaModifier("modifier_necrolyte_aesthetics_death", "heroes/hero_necrolyte/necrolyte_aesthetics_death.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_necrolyte_aesthetics_death_emitter", "heroes/hero_necrolyte/necrolyte_aesthetics_death.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_necrolyte_aesthetics_death_enemy", "heroes/hero_necrolyte/necrolyte_aesthetics_death.lua", LUA_MODIFIER_MOTION_HORIZONTAL)
LinkLuaModifier("modifier_necrolyte_aesthetics_death_enemy_execute_debuff", "heroes/hero_necrolyte/necrolyte_aesthetics_death.lua", LUA_MODIFIER_MOTION_HORIZONTAL)
...
function modifier_necrolyte_aesthetics_death_enemy:OnIntervalThink()
    ...
    local damage = (ability:GetSpecialValueFor("damage") + (caster:GetIntellect() * (ability:GetSpecialValueFor("int_to_damage")/100))) * 0.25
