LinkLuaModifier("modifier_necrolyte_reaper_form", "heroes/hero_necrolyte/necrolyte_reaper_form.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_necrolyte_reaper_form_buff", "heroes/hero_necrolyte/necrolyte_reaper_form.lua", LUA_MODIFIER_MOTION_NONE)
