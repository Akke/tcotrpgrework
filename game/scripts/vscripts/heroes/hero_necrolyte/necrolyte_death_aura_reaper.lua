LinkLuaModifier("modifier_necrolyte_death_aura_reaper", "heroes/hero_necrolyte/necrolyte_death_aura_reaper.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_necrolyte_death_aura_reaper_emitter", "heroes/hero_necrolyte/necrolyte_death_aura_reaper.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_necrolyte_death_aura_reaper_enemy", "heroes/hero_necrolyte/necrolyte_death_aura_reaper.lua", LUA_MODIFIER_MOTION_NONE)
