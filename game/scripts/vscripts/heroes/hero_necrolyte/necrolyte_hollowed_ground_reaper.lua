LinkLuaModifier("modifier_necrolyte_hollowed_ground_reaper", "heroes/hero_necrolyte/necrolyte_hollowed_ground_reaper.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_necrolyte_hollowed_ground_reaper_emitter", "heroes/hero_necrolyte/necrolyte_hollowed_ground_reaper.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_necrolyte_hollowed_ground_reaper_emitter_aura", "heroes/hero_necrolyte/necrolyte_hollowed_ground_reaper.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_necrolyte_hollowed_ground_reaper_emitter:OnIntervalThink()
    ...
    for _,unit in ipairs(units) do
        if not unit:IsMagicImmune() and not unit:IsInvulnerable() then
            ...
            local damage = self.damage + (caster:GetIntellect() * (self.intToDamage/100))
