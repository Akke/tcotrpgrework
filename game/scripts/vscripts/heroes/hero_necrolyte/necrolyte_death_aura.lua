LinkLuaModifier("modifier_necrolyte_death_aura", "heroes/hero_necrolyte/necrolyte_death_aura.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_necrolyte_death_aura_enemy", "heroes/hero_necrolyte/necrolyte_death_aura.lua", LUA_MODIFIER_MOTION_NONE)
