LinkLuaModifier("modifier_timmy_crit", "heroes/hero_timmy/timmy_crit.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_timmy_crit_buff", "heroes/hero_timmy/timmy_crit.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_timmy_crit_debuff", "heroes/hero_timmy/timmy_crit.lua", LUA_MODIFIER_MOTION_NONE)
