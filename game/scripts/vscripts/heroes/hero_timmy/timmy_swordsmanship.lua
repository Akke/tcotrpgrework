LinkLuaModifier("modifier_timmy_swordsmanship", "heroes/hero_timmy/timmy_swordsmanship.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_timmy_swordsmanship_buff", "heroes/hero_timmy/timmy_swordsmanship.lua", LUA_MODIFIER_MOTION_NONE)
