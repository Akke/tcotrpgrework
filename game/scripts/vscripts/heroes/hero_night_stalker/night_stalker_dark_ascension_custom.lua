LinkLuaModifier("modifier_night_stalker_dark_ascension_custom", "heroes/hero_night_stalker/night_stalker_dark_ascension_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_dark_ascension_custom_stacks_damage", "heroes/hero_night_stalker/night_stalker_dark_ascension_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_dark_ascension_custom_stacks_bat", "heroes/hero_night_stalker/night_stalker_dark_ascension_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_dark_ascension_custom_stacks_spell", "heroes/hero_night_stalker/night_stalker_dark_ascension_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_dark_ascension_custom_stacks_mana", "heroes/hero_night_stalker/night_stalker_dark_ascension_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_dark_ascension_custom_stacks_strength", "heroes/hero_night_stalker/night_stalker_dark_ascension_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_dark_ascension_custom_stacks_strength_to_spell", "heroes/hero_night_stalker/night_stalker_dark_ascension_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_dark_ascension_custom_debuff", "heroes/hero_night_stalker/night_stalker_dark_ascension_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_dark_ascension_custom_talent_crit_buff", "heroes/hero_night_stalker/night_stalker_dark_ascension_custom.lua", LUA_MODIFIER_MOTION_NONE)
