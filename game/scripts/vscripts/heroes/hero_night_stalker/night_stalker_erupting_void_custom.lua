LinkLuaModifier("modifier_night_stalker_erupting_void_custom", "heroes/hero_night_stalker/night_stalker_erupting_void_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_erupting_void_custom_eruption_debuff", "heroes/hero_night_stalker/night_stalker_erupting_void_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_erupting_void_custom_eruption_aura", "heroes/hero_night_stalker/night_stalker_erupting_void_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_erupting_void_custom_eruption_end_slow", "heroes/hero_night_stalker/night_stalker_erupting_void_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_erupting_void_custom_silence", "heroes/hero_night_stalker/night_stalker_erupting_void_custom.lua", LUA_MODIFIER_MOTION_NONE)
