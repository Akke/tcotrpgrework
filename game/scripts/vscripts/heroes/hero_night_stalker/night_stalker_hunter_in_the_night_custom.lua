-- Thanks to Dota IMBA for the hunter in the night model code and effects https://github.com/EarthSalamander42/dota_imba/blob/master/game/scripts/vscripts/components/abilities/heroes/hero_night_stalker.lua
LinkLuaModifier("modifier_night_stalker_hunter_in_the_night_custom", "heroes/hero_night_stalker/night_stalker_hunter_in_the_night_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_hunter_in_the_night_custom_flying", "heroes/hero_night_stalker/night_stalker_hunter_in_the_night_custom.lua", LUA_MODIFIER_MOTION_NONE)
