LinkLuaModifier("modifier_night_stalker_crippling_fear_custom", "heroes/hero_night_stalker/night_stalker_crippling_fear_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_night_stalker_crippling_fear_custom_debuff", "heroes/hero_night_stalker/night_stalker_crippling_fear_custom.lua", LUA_MODIFIER_MOTION_NONE)
