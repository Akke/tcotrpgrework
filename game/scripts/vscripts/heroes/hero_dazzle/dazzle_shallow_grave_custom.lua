LinkLuaModifier("modifier_dazzle_shallow_grave_custom", "heroes/hero_dazzle/dazzle_shallow_grave_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dazzle_shallow_grave_custom_aura", "heroes/hero_dazzle/dazzle_shallow_grave_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dazzle_shallow_grave_custom_buff", "heroes/hero_dazzle/dazzle_shallow_grave_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dazzle_shallow_grave_custom_cooldown", "heroes/hero_dazzle/dazzle_shallow_grave_custom.lua", LUA_MODIFIER_MOTION_NONE)
