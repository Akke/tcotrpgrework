LinkLuaModifier("modifier_dazzle_nothl_protection_custom", "heroes/hero_dazzle/dazzle_nothl_protection_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dazzle_nothl_protection_custom_absorb_state", "heroes/hero_dazzle/dazzle_nothl_protection_custom.lua", LUA_MODIFIER_MOTION_NONE)
