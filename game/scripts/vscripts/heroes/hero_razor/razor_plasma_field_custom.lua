...
LinkLuaModifier( "modifier_razor_plasma_field_custom", "heroes/hero_razor/razor_plasma_field_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_razor_plasma_field_custom_base", "heroes/hero_razor/razor_plasma_field_custom.lua", LUA_MODIFIER_MOTION_NONE )
