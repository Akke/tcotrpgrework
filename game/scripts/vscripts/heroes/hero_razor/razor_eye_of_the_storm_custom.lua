...
LinkLuaModifier( "modifier_razor_eye_of_the_storm_custom", "heroes/hero_razor/razor_eye_of_the_storm_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_razor_eye_of_the_storm_custom_debuff", "heroes/hero_razor/razor_eye_of_the_storm_custom.lua", LUA_MODIFIER_MOTION_NONE )
