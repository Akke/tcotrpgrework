LinkLuaModifier("modifier_centaur_hoof_stomp_custom", "heroes/hero_centaur/centaur_hoof_stomp_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_centaur_hoof_stomp_custom_debuff", "heroes/hero_centaur/centaur_hoof_stomp_custom.lua", LUA_MODIFIER_MOTION_NONE)
