LinkLuaModifier("modifier_centaur_stampede_custom", "heroes/hero_centaur/centaur_stampede_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_centaur_stampede_custom_buff", "heroes/hero_centaur/centaur_stampede_custom.lua", LUA_MODIFIER_MOTION_NONE)
