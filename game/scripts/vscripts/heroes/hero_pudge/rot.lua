LinkLuaModifier("modifier_pudge_rot_custom", "heroes/hero_pudge/rot.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_pudge_rot_custom_aura", "heroes/hero_pudge/rot.lua", LUA_MODIFIER_MOTION_NONE)
