LinkLuaModifier("modifier_lich_ice_spire_custom_field", "heroes/hero_lich/ice_spire/lich_ice_spire_custom_field.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lich_ice_spire_custom_field_aura", "heroes/hero_lich/ice_spire/lich_ice_spire_custom_field.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_lich_ice_spire_custom_field_aura:OnCreated()
    ...
    local damage = ability:GetSpecialValueFor("damage") + (owner:GetIntellect() * (innateIceSpire:GetSpecialValueFor("int_to_damage")/100))
