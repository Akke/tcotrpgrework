LinkLuaModifier("modifier_lich_ice_spire_custom_icy_aura", "heroes/hero_lich/ice_spire/lich_ice_spire_custom_icy_aura.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lich_ice_spire_custom_icy_aura_aura", "heroes/hero_lich/ice_spire/lich_ice_spire_custom_icy_aura.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lich_ice_spire_custom_icy_aura_aura_enemy", "heroes/hero_lich/ice_spire/lich_ice_spire_custom_icy_aura.lua", LUA_MODIFIER_MOTION_NONE)
