LinkLuaModifier("modifier_lich_frost_nova_custom", "heroes/hero_lich/lich_frost_nova_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lich_frost_nova_custom_debuff", "heroes/hero_lich/lich_frost_nova_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function lich_frost_nova_custom:OnSpellStart()
    ...
    local intellectDamage = self:GetCaster():GetIntellect() * (self:GetSpecialValueFor("int_to_damage")/100)
