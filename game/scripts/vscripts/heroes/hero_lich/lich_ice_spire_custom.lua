LinkLuaModifier("modifier_lich_ice_spire_custom", "heroes/hero_lich/lich_ice_spire_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lich_ice_spire_custom_thinker", "heroes/hero_lich/lich_ice_spire_custom.lua", LUA_MODIFIER_MOTION_NONE)
