...
LinkLuaModifier( "modifier_lich_chain_frost_custom", "heroes/hero_lich/lich_chain_frost_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_lich_chain_frost_custom_thinker", "heroes/hero_lich/lich_chain_frost_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_generic_tracking_projectile", "modifiers/modifier_generic_tracking_projectile.lua", LUA_MODIFIER_MOTION_NONE )
...
function lich_chain_frost_custom:OnSpellStart()
    ...
    -- load data
    local damage = self:GetSpecialValueFor("damage") + (self:GetCaster():GetIntellect() * (self:GetSpecialValueFor("int_to_damage")/100))
