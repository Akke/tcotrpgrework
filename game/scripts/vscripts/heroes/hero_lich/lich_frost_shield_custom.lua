LinkLuaModifier("modifier_lich_frost_shield_custom", "heroes/hero_lich/lich_frost_shield_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lich_frost_shield_custom_buff", "heroes/hero_lich/lich_frost_shield_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lich_frost_shield_custom_debuff", "heroes/hero_lich/lich_frost_shield_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_lich_frost_shield_custom_buff:OnCreated()
    ...
    self.damage = ability:GetSpecialValueFor("damage") + (caster:GetIntellect() * (ability:GetSpecialValueFor("int_to_damage")/100))
    ...
    self.armor = caster:GetIntellect() * multiplier
