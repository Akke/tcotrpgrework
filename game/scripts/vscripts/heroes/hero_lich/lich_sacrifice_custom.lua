LinkLuaModifier("modifier_lich_sacrifice_custom", "heroes/hero_lich/lich_sacrifice_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lich_sacrifice_custom_buff_permanent", "heroes/hero_lich/lich_sacrifice_custom.lua", LUA_MODIFIER_MOTION_NONE)
