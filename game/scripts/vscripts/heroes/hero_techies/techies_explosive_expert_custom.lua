LinkLuaModifier("modifier_techies_explosive_expert_custom", "heroes/hero_techies/techies_explosive_expert_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_techies_explosive_expert_custom_buff", "heroes/hero_techies/techies_explosive_expert_custom.lua", LUA_MODIFIER_MOTION_NONE)
