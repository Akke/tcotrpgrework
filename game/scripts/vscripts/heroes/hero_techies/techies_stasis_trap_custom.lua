LinkLuaModifier("modifier_techies_stasis_trap_custom", "heroes/hero_techies/techies_stasis_trap_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_techies_stasis_trap_custom_thinker", "heroes/hero_techies/techies_stasis_trap_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_movement_speed_uba", "modifiers/modifier_movement_speed_uba.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_techies_stasis_trap_custom_debuff", "heroes/hero_techies/techies_stasis_trap_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_techies_stasis_trap_custom_thinker:OnIntervalThink()
    ...
    for _,enemy in pairs(enemies) do
        ApplyDamage({
            victim = enemy,
            attacker = owner,
            damage = self:GetAbility():GetSpecialValueFor("damage") + (owner:GetIntellect() * (self:GetAbility():GetSpecialValueFor("int_to_damage")/100)),
