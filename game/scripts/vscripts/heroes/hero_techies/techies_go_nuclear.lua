LinkLuaModifier("modifier_techies_go_nuclear", "heroes/hero_techies/techies_go_nuclear.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_techies_go_nuclear_buff", "heroes/hero_techies/techies_go_nuclear.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_techies_go_nuclear_debuff_stunned", "heroes/hero_techies/techies_go_nuclear.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_techies_go_nuclear_debuff_silenced", "heroes/hero_techies/techies_go_nuclear.lua", LUA_MODIFIER_MOTION_NONE)
