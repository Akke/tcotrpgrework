LinkLuaModifier("modifier_techies_land_mines_custom", "heroes/hero_techies/techies_land_mines_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_techies_land_mines_custom_thinker", "heroes/hero_techies/techies_land_mines_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_techies_land_mines_custom_debuff", "heroes/hero_techies/techies_land_mines_custom.lua", LUA_MODIFIER_MOTION_NONE)
            ...
            if parent ~= nil and not self.triggered then
                ...
                for _,enemy in ipairs(enemies) do
                    ApplyDamage({
                        victim = enemy,
                        attacker = owner,
                        damage = (ability:GetSpecialValueFor("damage") + (owner:GetIntellect() * (ability:GetSpecialValueFor("int_to_damage")/100))) * self.i,
