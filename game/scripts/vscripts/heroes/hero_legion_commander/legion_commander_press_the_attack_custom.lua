LinkLuaModifier("modifier_legion_commander_press_the_attack_custom", "heroes/hero_legion_commander/legion_commander_press_the_attack_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_legion_commander_press_the_attack_custom_aura", "heroes/hero_legion_commander/legion_commander_press_the_attack_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_legion_commander_press_the_attack_custom_buff", "heroes/hero_legion_commander/legion_commander_press_the_attack_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_legion_commander_press_the_attack_custom_buff_shard", "heroes/hero_legion_commander/legion_commander_press_the_attack_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_legion_commander_press_the_attack_custom_cooldown", "heroes/hero_legion_commander/legion_commander_press_the_attack_custom.lua", LUA_MODIFIER_MOTION_NONE)
