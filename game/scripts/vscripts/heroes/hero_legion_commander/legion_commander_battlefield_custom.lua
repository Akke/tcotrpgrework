LinkLuaModifier("modifier_legion_commander_battlefield_custom", "heroes/hero_legion_commander/legion_commander_battlefield_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_legion_commander_battlefield_custom_emitter", "heroes/hero_legion_commander/legion_commander_battlefield_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_legion_commander_battlefield_custom_emitter_aura", "heroes/hero_legion_commander/legion_commander_battlefield_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_legion_commander_battlefield_custom_arrow_thinker", "heroes/hero_legion_commander/legion_commander_battlefield_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_legion_commander_battlefield_custom_arrow_debuff", "heroes/hero_legion_commander/legion_commander_battlefield_custom.lua", LUA_MODIFIER_MOTION_NONE)
