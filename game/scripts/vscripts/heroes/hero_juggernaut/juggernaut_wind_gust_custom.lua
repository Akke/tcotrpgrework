LinkLuaModifier("modifier_juggernaut_wind_gust_custom", "heroes/hero_juggernaut/juggernaut_wind_gust_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_juggernaut_wind_gust_custom_debuff", "heroes/hero_juggernaut/juggernaut_wind_gust_custom.lua", LUA_MODIFIER_MOTION_NONE)
