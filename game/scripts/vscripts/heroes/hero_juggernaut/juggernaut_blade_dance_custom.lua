...
LinkLuaModifier( "modifier_juggernaut_blade_dance_custom", "heroes/hero_juggernaut/juggernaut_blade_dance_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_juggernaut_blade_dance_custom_agility_boost", "heroes/hero_juggernaut/juggernaut_blade_dance_custom.lua", LUA_MODIFIER_MOTION_NONE )
