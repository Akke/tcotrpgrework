LinkLuaModifier("modifier_juggernaut_jade_dragonling_custom", "heroes/hero_juggernaut/juggernaut_jade_dragonling_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_juggernaut_jade_dragonling_custom_shard", "heroes/hero_juggernaut/juggernaut_jade_dragonling_custom.lua", LUA_MODIFIER_MOTION_NONE)
