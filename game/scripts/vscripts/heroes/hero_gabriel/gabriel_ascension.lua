LinkLuaModifier("modifier_gabriel_ascension", "heroes/hero_gabriel/gabriel_ascension.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_gabriel_ascension_buff", "heroes/hero_gabriel/gabriel_ascension.lua", LUA_MODIFIER_MOTION_NONE)
