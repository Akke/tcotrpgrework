LinkLuaModifier("modifier_gabriel_purity", "heroes/hero_gabriel/gabriel_purity.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_gabriel_purity_debuff", "heroes/hero_gabriel/gabriel_purity.lua", LUA_MODIFIER_MOTION_NONE)
