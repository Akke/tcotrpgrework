--[[
    ...
    https://github.com/EarthSalamander42/dota_imba/blob/master/game/scripts/vscripts/components/abilities/heroes/hero_ember_spirit.lua
]]--
LinkLuaModifier("modifier_gabriel_divine_retribution", "heroes/hero_gabriel/gabriel_divine_retribution.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_gabriel_divine_retribution_target", "heroes/hero_gabriel/gabriel_divine_retribution.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_gabriel_divine_retribution_caster", "heroes/hero_gabriel/gabriel_divine_retribution.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_gabriel_divine_retribution_autocast", "heroes/hero_gabriel/gabriel_divine_retribution.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_gabriel_divine_retribution_scepter_buff", "heroes/hero_gabriel/gabriel_divine_retribution.lua", LUA_MODIFIER_MOTION_NONE)
