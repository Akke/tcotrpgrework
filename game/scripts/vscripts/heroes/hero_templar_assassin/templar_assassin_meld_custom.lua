LinkLuaModifier("modifier_templar_assassin_meld_custom", "heroes/hero_templar_assassin/templar_assassin_meld_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_templar_assassin_meld_custom_crit_stacks", "heroes/hero_templar_assassin/templar_assassin_meld_custom.lua", LUA_MODIFIER_MOTION_NONE)
