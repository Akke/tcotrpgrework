LinkLuaModifier("modifier_templar_assassin_psionic_explosion_custom", "heroes/hero_templar_assassin/templar_assassin_psionic_explosion_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_templar_assassin_psionic_explosion_custom_debuff", "heroes/hero_templar_assassin/templar_assassin_psionic_explosion_custom.lua", LUA_MODIFIER_MOTION_NONE)
