...
LinkLuaModifier("modifier_templar_assassin_psi_blades_custom", "heroes/hero_templar_assassin/templar_assassin_psi_blades_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_templar_assassin_psi_blades_custom_cd", "heroes/hero_templar_assassin/templar_assassin_psi_blades_custom.lua", LUA_MODIFIER_MOTION_NONE)
