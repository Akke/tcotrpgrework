LinkLuaModifier("modifier_templar_assassin_refraction_custom", "heroes/hero_templar_assassin/templar_assassin_refraction_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_templar_assassin_refraction_custom_damage", "heroes/hero_templar_assassin/templar_assassin_refraction_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_templar_assassin_refraction_custom_grace", "heroes/hero_templar_assassin/templar_assassin_refraction_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_templar_assassin_refraction_custom_grace_cd", "heroes/hero_templar_assassin/templar_assassin_refraction_custom.lua", LUA_MODIFIER_MOTION_NONE)
