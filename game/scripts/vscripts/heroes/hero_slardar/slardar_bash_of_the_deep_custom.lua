LinkLuaModifier("modifier_slardar_bash_of_the_deep_custom", "heroes/hero_slardar/slardar_bash_of_the_deep_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_slardar_bash_of_the_deep_custom_debuff", "heroes/hero_slardar/slardar_bash_of_the_deep_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_slardar_bash_of_the_deep_custom_stacks", "heroes/hero_slardar/slardar_bash_of_the_deep_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_slardar_bash_of_the_deep_custom_buff", "heroes/hero_slardar/slardar_bash_of_the_deep_custom.lua", LUA_MODIFIER_MOTION_NONE)
