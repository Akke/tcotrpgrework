LinkLuaModifier("modifier_slardar_slithereen_crush_custom", "heroes/hero_slardar/slardar_slithereen_crush_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_slardar_slithereen_crush_custom_emitter", "heroes/hero_slardar/slardar_slithereen_crush_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_slardar_slithereen_crush_custom_emitter_aura", "heroes/hero_slardar/slardar_slithereen_crush_custom.lua", LUA_MODIFIER_MOTION_NONE)
