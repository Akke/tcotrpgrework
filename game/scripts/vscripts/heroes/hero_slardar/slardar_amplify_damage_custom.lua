LinkLuaModifier("modifier_slardar_amplify_damage_custom", "heroes/hero_slardar/slardar_amplify_damage_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_slardar_amplify_damage_custom_debuff", "heroes/hero_slardar/slardar_amplify_damage_custom.lua", LUA_MODIFIER_MOTION_NONE)
