LinkLuaModifier("modifier_alchemist_chemical_rage_custom", "heroes/hero_alchemist/alchemist_chemical_rage_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_alchemist_chemical_rage_custom_buff", "heroes/hero_alchemist/alchemist_chemical_rage_custom.lua", LUA_MODIFIER_MOTION_NONE)
