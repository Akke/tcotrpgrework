LinkLuaModifier("modifier_alchemist_chemical_gold_transfusion_custom", "heroes/hero_alchemist/alchemist_chemical_gold_transfusion_custom.lua", LUA_MODIFIER_MOTION_NONE)
