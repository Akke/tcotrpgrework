LinkLuaModifier("modifier_alchemist_chemical_greevils_greed_custom", "heroes/hero_alchemist/alchemist_chemical_greevils_greed_custom.lua", LUA_MODIFIER_MOTION_NONE)
