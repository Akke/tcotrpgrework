LinkLuaModifier("modifier_slark_depth_shroud_custom", "heroes/hero_slark/slark_depth_shroud_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_slark_depth_shroud_custom_buff", "heroes/hero_slark/slark_depth_shroud_custom.lua", LUA_MODIFIER_MOTION_NONE)
