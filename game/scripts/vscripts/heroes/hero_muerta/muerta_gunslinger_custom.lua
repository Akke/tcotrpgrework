LinkLuaModifier("modifier_muerta_gunslinger_custom", "heroes/hero_muerta/muerta_gunslinger_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_muerta_gunslinger_custom_debuff", "heroes/hero_muerta/muerta_gunslinger_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_muerta_gunslinger_custom_doubleshot_damage", "heroes/hero_muerta/muerta_gunslinger_custom.lua", LUA_MODIFIER_MOTION_NONE)
