LinkLuaModifier("modifier_tidehunter_anchor_smash_custom", "heroes/hero_tidehunter/tidehunter_anchor_smash_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_tidehunter_anchor_smash_custom_debuff", "heroes/hero_tidehunter/tidehunter_anchor_smash_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_tidehunter_anchor_smash_custom_buff", "heroes/hero_tidehunter/tidehunter_anchor_smash_custom.lua", LUA_MODIFIER_MOTION_NONE)
