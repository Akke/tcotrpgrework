LinkLuaModifier("modifier_tidehunter_tentacle_custom", "heroes/hero_tidehunter/tidehunter_tentacle_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_tidehunter_tentacle_custom_debuff", "heroes/hero_tidehunter/tidehunter_tentacle_custom.lua", LUA_MODIFIER_MOTION_NONE)
