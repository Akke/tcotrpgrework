LinkLuaModifier("modifier_talent_tidehunter_2", "heroes/hero_tidehunter/talents/talent_tidehunter_2.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_talent_tidehunter_2_shield", "heroes/hero_tidehunter/talents/talent_tidehunter_2.lua", LUA_MODIFIER_MOTION_NONE)
