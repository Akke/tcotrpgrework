LinkLuaModifier("modifier_talent_tidehunter_1", "heroes/hero_tidehunter/talents/talent_tidehunter_1.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_talent_tidehunter_1_debuff_frozen", "heroes/hero_tidehunter/talents/talent_tidehunter_1.lua", LUA_MODIFIER_MOTION_NONE)
