...
function modifier_chicken_ability_7_buff:OnRefresh()
    ...
    self.str = caster:GetStrength() * (self:GetAbility():GetSpecialValueFor("stats_share_pct")/100)
    self.agi = caster:GetAgility() * (self:GetAbility():GetSpecialValueFor("stats_share_pct")/100)
    self.int = caster:GetIntellect() * (self:GetAbility():GetSpecialValueFor("stats_share_pct")/100)
