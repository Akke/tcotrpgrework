LinkLuaModifier("modifier_snapfire_firesnap_cookie_custom", "heroes/hero_snapfire/snapfire_firesnap_cookie_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_snapfire_firesnap_cookie_custom_buff", "heroes/hero_snapfire/snapfire_firesnap_cookie_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_snapfire_firesnap_cookie_custom_aura", "heroes/hero_snapfire/snapfire_firesnap_cookie_custom.lua", LUA_MODIFIER_MOTION_NONE)
