...
LinkLuaModifier( "modifier_snapfire_lil_shredder_custom", "heroes/hero_snapfire/snapfire_lil_shredder_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_snapfire_lil_shredder_custom_debuff", "heroes/hero_snapfire/snapfire_lil_shredder_custom.lua", LUA_MODIFIER_MOTION_NONE )
