...
LinkLuaModifier( "modifier_snapfire_scatterblast_custom_intrin", "heroes/hero_snapfire/snapfire_scatterblast_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_snapfire_scatterblast_custom", "heroes/hero_snapfire/snapfire_scatterblast_custom.lua", LUA_MODIFIER_MOTION_NONE )
