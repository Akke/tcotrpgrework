LinkLuaModifier("modifier_oracle_rain_of_destiny_custom", "heroes/hero_oracle/oracle_rain_of_destiny_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_oracle_rain_of_destiny_custom_thinker", "heroes/hero_oracle/oracle_rain_of_destiny_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_oracle_rain_of_destiny_custom_buff", "heroes/hero_oracle/oracle_rain_of_destiny_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_oracle_rain_of_destiny_custom_debuff", "heroes/hero_oracle/oracle_rain_of_destiny_custom.lua", LUA_MODIFIER_MOTION_NONE)
