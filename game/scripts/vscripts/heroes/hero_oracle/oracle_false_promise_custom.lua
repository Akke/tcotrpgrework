LinkLuaModifier("modifier_oracle_false_promise_custom", "heroes/hero_oracle/oracle_false_promise_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_oracle_false_promise_custom_debuff_1", "heroes/hero_oracle/oracle_false_promise_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_oracle_false_promise_custom_debuff_2", "heroes/hero_oracle/oracle_false_promise_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_oracle_false_promise_custom_debuff_3", "heroes/hero_oracle/oracle_false_promise_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_oracle_false_promise_custom_buff_1", "heroes/hero_oracle/oracle_false_promise_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_oracle_false_promise_custom_buff_2", "heroes/hero_oracle/oracle_false_promise_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_oracle_false_promise_custom_buff_3", "heroes/hero_oracle/oracle_false_promise_custom.lua", LUA_MODIFIER_MOTION_NONE)
