LinkLuaModifier("modifier_oracle_fortunes_end_custom", "heroes/hero_oracle/oracle_fortunes_end_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_oracle_fortunes_end_custom_debuff", "heroes/hero_oracle/oracle_fortunes_end_custom.lua", LUA_MODIFIER_MOTION_NONE)
