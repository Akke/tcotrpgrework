LinkLuaModifier("modifier_oracle_fates_edict_custom", "heroes/hero_oracle/oracle_fates_edict_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_oracle_fates_edict_custom_aura", "heroes/hero_oracle/oracle_fates_edict_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_oracle_fates_edict_custom_aura_ally", "heroes/hero_oracle/oracle_fates_edict_custom.lua", LUA_MODIFIER_MOTION_NONE)
