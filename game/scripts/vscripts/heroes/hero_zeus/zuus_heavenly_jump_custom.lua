LinkLuaModifier("modifier_zuus_heavenly_jump_custom", "heroes/hero_zeus/zuus_heavenly_jump_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zuus_heavenly_jump_custom_debuff", "heroes/hero_zeus/zuus_heavenly_jump_custom.lua", LUA_MODIFIER_MOTION_NONE)
