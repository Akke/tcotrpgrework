LinkLuaModifier("modifier_zuus_arc_lightning_custom", "heroes/hero_zeus/zuus_arc_lightning_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zuus_arc_lightning_custom_slow_debuff", "heroes/hero_zeus/zuus_arc_lightning_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zuus_arc_lightning_custom_magic_reduction_debuff", "heroes/hero_zeus/zuus_arc_lightning_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function zuus_arc_lightning_custom:OnSpellStart()
    ...
    self.damage = self:GetSpecialValueFor("arc_damage") + (caster:GetIntellect() * (self:GetSpecialValueFor("int_to_damage")/100))
    self.radius = self:GetSpecialValueFor("radius")
    self.hasShard = caster:HasModifier("modifier_item_aghanims_shard")
    self.lightningBoltDamage = self:GetSpecialValueFor("lightning_bolt_damage") + (caster:GetIntellect() * (self:GetSpecialValueFor("int_to_damage")/100))
