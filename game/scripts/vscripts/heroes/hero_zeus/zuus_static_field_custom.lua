LinkLuaModifier("modifier_zuus_static_field_custom", "heroes/hero_zeus/zuus_static_field_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zuus_static_field_custom_stacks", "heroes/hero_zeus/zuus_static_field_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zuus_static_field_custom_active", "heroes/hero_zeus/zuus_static_field_custom.lua", LUA_MODIFIER_MOTION_NONE)
