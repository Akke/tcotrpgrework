LinkLuaModifier("modifier_zuus_transcendence_custom", "heroes/hero_zeus/zuus_transcendence_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zuus_transcendence_descend_custom", "heroes/hero_zeus/zuus_transcendence_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zuus_transcendence_custom_transport", "heroes/hero_zeus/zuus_transcendence_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zuus_transcendence_custom_debuff", "heroes/hero_zeus/zuus_transcendence_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function zuus_transcendence_custom_descend:OnSpellStart()
    ...
    local damage = self:GetSpecialValueFor("damage") + (caster:GetIntellect() * (self:GetSpecialValueFor("int_to_damage")/100))
