LinkLuaModifier("modifier_zuus_thundergods_wrath_custom", "heroes/hero_zeus/zuus_thundergods_wrath_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_zuus_thundergods_wrath_custom_active", "heroes/hero_zeus/zuus_thundergods_wrath_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_zuus_thundergods_wrath_custom_active:OnCreated(params)
    ...
    self.damage = self.ability:GetSpecialValueFor("damage") + (self.parent:GetIntellect() * (self.ability:GetSpecialValueFor("int_to_damage")/100))
