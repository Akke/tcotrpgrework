...
LinkLuaModifier( "modifier_obsidian_arcane_orb_custom", "heroes/hero_obsidian/obsidian_arcane_orb_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_obsidian_arcane_orb_custom_stack", "heroes/hero_obsidian/obsidian_arcane_orb_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_obsidian_essence_flux", "heroes/hero_obsidian/obsidian_essence_flux.lua", LUA_MODIFIER_MOTION_NONE)
