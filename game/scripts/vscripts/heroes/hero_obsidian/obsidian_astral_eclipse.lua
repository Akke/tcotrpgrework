LinkLuaModifier("modifier_obsidian_astral_eclipse", "heroes/hero_obsidian/obsidian_astral_eclipse.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_obsidian_astral_eclipse_emitter", "heroes/hero_obsidian/obsidian_astral_eclipse.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_obsidian_astral_eclipse_debuff", "heroes/hero_obsidian/obsidian_astral_eclipse.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_obsidian_astral_eclipse_debuff_slowed", "heroes/hero_obsidian/obsidian_astral_eclipse.lua", LUA_MODIFIER_MOTION_NONE)
    ...
    for _,unit in ipairs(units) do
        if not unit:IsMagicImmune() and not unit:IsInvulnerable() then
            ApplyDamage({
                victim = unit,
                attacker = caster,
                damage = self.damage + (caster:GetIntellect() * (self.intToDamage/100)),
