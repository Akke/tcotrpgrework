LinkLuaModifier("modifier_troll_warlord_berserkers_rage_custom", "heroes/hero_troll_warlord/troll_warlord_berserkers_rage_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_troll_warlord_berserkers_rage_custom_melee", "heroes/hero_troll_warlord/troll_warlord_berserkers_rage_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_troll_warlord_berserkers_rage_custom_ranged", "heroes/hero_troll_warlord/troll_warlord_berserkers_rage_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_troll_warlord_berserkers_rage_custom_ranged_axe_cooldown", "heroes/hero_troll_warlord/troll_warlord_berserkers_rage_custom.lua", LUA_MODIFIER_MOTION_NONE)
