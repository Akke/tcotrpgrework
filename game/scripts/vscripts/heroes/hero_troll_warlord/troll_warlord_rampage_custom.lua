LinkLuaModifier("modifier_troll_warlord_rampage_custom", "heroes/hero_troll_warlord/troll_warlord_rampage_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_troll_warlord_rampage_custom_buff", "heroes/hero_troll_warlord/troll_warlord_rampage_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_troll_warlord_rampage_custom_debuff", "heroes/hero_troll_warlord/troll_warlord_rampage_custom.lua", LUA_MODIFIER_MOTION_NONE)
