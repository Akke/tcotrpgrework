LinkLuaModifier("modifier_fenrir_summon_pup", "heroes/hero_fenrir/fenrir_summon_pup.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_fenrir_summon_pup_intrin", "heroes/hero_fenrir/fenrir_summon_pup.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_fenrir_summon_pup_aura", "heroes/hero_fenrir/fenrir_summon_pup.lua", LUA_MODIFIER_MOTION_NONE)
