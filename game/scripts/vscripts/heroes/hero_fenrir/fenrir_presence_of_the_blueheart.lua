LinkLuaModifier("modifier_fenrir_presence_of_the_blueheart", "heroes/hero_fenrir/fenrir_presence_of_the_blueheart.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_fenrir_presence_of_the_blueheart_aura", "heroes/hero_fenrir/fenrir_presence_of_the_blueheart.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_fenrir_presence_of_the_blueheart_aura:OnTooltip()
    if self:GetCaster()==self:GetParent() then
        local agi = self:GetCaster():GetIntellect()
