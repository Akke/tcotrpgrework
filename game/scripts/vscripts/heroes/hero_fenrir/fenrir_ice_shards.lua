LinkLuaModifier("modifier_fenrir_ice_shards", "heroes/hero_fenrir/fenrir_ice_shards.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_fenrir_ice_shards_debuff", "heroes/hero_fenrir/fenrir_ice_shards.lua", LUA_MODIFIER_MOTION_NONE)
