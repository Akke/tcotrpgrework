LinkLuaModifier("modifier_fenrir_avalanche", "heroes/hero_fenrir/fenrir_avalanche.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_fenrir_avalanche_overheal", "heroes/hero_fenrir/fenrir_avalanche.lua", LUA_MODIFIER_MOTION_NONE)
