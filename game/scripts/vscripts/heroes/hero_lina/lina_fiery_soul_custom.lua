LinkLuaModifier("modifier_lina_fiery_soul_custom", "heroes/hero_lina/lina_fiery_soul_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lina_fiery_soul_custom_def", "heroes/hero_lina/lina_fiery_soul_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lina_fiery_soul_custom_buff", "heroes/hero_lina/lina_fiery_soul_custom.lua", LUA_MODIFIER_MOTION_NONE)
