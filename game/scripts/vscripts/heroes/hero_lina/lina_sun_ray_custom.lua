LinkLuaModifier("modifier_lina_sun_ray_custom", "heroes/hero_lina/lina_sun_ray_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lina_sun_ray_custom_debuff", "heroes/hero_lina/lina_sun_ray_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lina_sun_ray_custom_debuff_burning", "heroes/hero_lina/lina_sun_ray_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_lina_sun_ray_custom_debuff_burning:OnIntervalThink()
    ...
    local damage = (parent:GetHealth() * (ability:GetSpecialValueFor("burn_current_hp_pct")/100)) + (caster:GetIntellect() * (ability:GetSpecialValueFor("int_to_damage")/100))
