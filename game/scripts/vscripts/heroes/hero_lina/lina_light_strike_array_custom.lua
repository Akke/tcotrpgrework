...
LinkLuaModifier( "modifier_lina_light_strike_array_custom", "heroes/hero_lina/lina_light_strike_array_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier("modifier_lina_light_strike_array_custom_def", "heroes/hero_lina/lina_light_strike_array_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lina_light_strike_array_custom_debuff", "heroes/hero_lina/lina_light_strike_array_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_lina_light_strike_array_custom:OnDestroy()
    ...
    local damage = self.damage + (self:GetCaster():GetIntellect() * (self:GetAbility():GetSpecialValueFor("int_to_damage")/100))
    local caster = self:GetCaster()
...
function modifier_lina_light_strike_array_custom_debuff:OnIntervalThink()
    local damage = self:GetStackCount() * (self:GetAbility():GetSpecialValueFor("burn_dps") + (self:GetCaster():GetIntellect() * (self:GetAbility():GetSpecialValueFor("int_to_damage")/100)))
    local caster = self:GetCaster()
