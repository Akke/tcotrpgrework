LinkLuaModifier("modifier_lina_dragon_slave_custom", "heroes/hero_lina/lina_dragon_slave_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lina_dragon_slave_custom_stack", "heroes/hero_lina/lina_dragon_slave_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function lina_dragon_slave_custom:OnProjectileHitHandle( target, location, projectile )
    ...
    local damage = self:GetSpecialValueFor("dragon_slave_damage") + (caster:GetIntellect() * (self:GetSpecialValueFor("int_to_damage")/100))
