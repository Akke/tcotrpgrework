LinkLuaModifier("modifier_lina_laguna_blade_custom", "heroes/hero_lina/lina_laguna_blade_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_lina_laguna_blade_custom_debuff", "heroes/hero_lina/lina_laguna_blade_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_lina_laguna_blade_custom:OnIntervalThink()
    ...
    local damage = ability:GetSpecialValueFor("damage") + (parent:GetIntellect() * (ability:GetSpecialValueFor("int_to_damage")/100))
