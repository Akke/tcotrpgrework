LinkLuaModifier("modifier_talent_lina_2", "heroes/hero_lina/talents/talent_lina_2.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_talent_lina_2_dragon_slave_debuff", "heroes/hero_lina/talents/talent_lina_2.lua", LUA_MODIFIER_MOTION_NONE)
