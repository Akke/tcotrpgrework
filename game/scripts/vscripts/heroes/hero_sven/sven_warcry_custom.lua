LinkLuaModifier("modifier_sven_warcry_custom", "heroes/hero_sven/sven_warcry_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sven_warcry_custom_intrin", "heroes/hero_sven/sven_warcry_custom.lua", LUA_MODIFIER_MOTION_NONE)
