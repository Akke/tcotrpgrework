LinkLuaModifier("modifier_sven_greater_cleave_custom", "heroes/hero_sven/sven_greater_cleave_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_sven_greater_cleave_custom_debuff", "heroes/hero_sven/sven_greater_cleave_custom.lua", LUA_MODIFIER_MOTION_NONE)
