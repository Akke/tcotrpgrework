LinkLuaModifier("modifier_sven_gods_strength_custom", "heroes/hero_sven/sven_gods_strength_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_sven_gods_strength_custom:OnCreated()
    ...
    if caster:HasModifier("modifier_item_aghanims_shard") then
        ...
        local intellect = caster:GetIntellect() * (ability:GetSpecialValueFor("shard_attribute_conversion")/100)
