...
LinkLuaModifier( "modifier_crystal_maiden_freezing_field_custom", "heroes/hero_crystal_maiden/crystal_maiden_freezing_field_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_crystal_maiden_freezing_field_custom_effect", "heroes/hero_crystal_maiden/crystal_maiden_freezing_field_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_crystal_maiden_freezing_field_custom_emitter", "heroes/hero_crystal_maiden/crystal_maiden_freezing_field_custom.lua", LUA_MODIFIER_MOTION_NONE )
...
function modifier_crystal_maiden_freezing_field_custom:OnCreated( kv )
    ...
    if IsServer() then
        ...
        self.damageTable = {
            -- victim = target,
            attacker = attacker,
            damage = explosion_damage + (attacker:GetIntellect() * (self:GetAbility():GetSpecialValueFor("int_to_damage")/100)),
