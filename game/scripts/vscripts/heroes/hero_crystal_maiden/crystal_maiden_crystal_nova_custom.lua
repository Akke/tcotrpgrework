LinkLuaModifier("modifier_crystal_maiden_crystal_nova_custom", "heroes/hero_crystal_maiden/crystal_maiden_crystal_nova_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_crystal_maiden_crystal_nova_custom_debuff", "heroes/hero_crystal_maiden/crystal_maiden_crystal_nova_custom.lua", LUA_MODIFIER_MOTION_NONE)
