LinkLuaModifier("modifier_crystal_maiden_frostbite_custom", "heroes/hero_crystal_maiden/crystal_maiden_frostbite_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_crystal_maiden_frostbite_custom_debuff", "heroes/hero_crystal_maiden/crystal_maiden_frostbite_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_crystal_maiden_frostbite_custom_debuff_frozen", "heroes/hero_crystal_maiden/crystal_maiden_frostbite_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_crystal_maiden_frostbite_custom_debuff_cooldown", "heroes/hero_crystal_maiden/crystal_maiden_frostbite_custom.lua", LUA_MODIFIER_MOTION_NONE)
