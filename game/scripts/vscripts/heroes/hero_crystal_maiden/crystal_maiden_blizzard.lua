LinkLuaModifier("modifier_crystal_maiden_blizzard", "heroes/hero_crystal_maiden/crystal_maiden_blizzard.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_crystal_maiden_blizzard_emitter", "heroes/hero_crystal_maiden/crystal_maiden_blizzard.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_crystal_maiden_blizzard_emitter_aura", "heroes/hero_crystal_maiden/crystal_maiden_blizzard.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_crystal_maiden_blizzard_emitter_aura_friendly", "heroes/hero_crystal_maiden/crystal_maiden_blizzard.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_crystal_maiden_blizzard_emitter_frozen_debuff", "heroes/hero_crystal_maiden/crystal_maiden_blizzard.lua", LUA_MODIFIER_MOTION_NONE)
    ...
    for _,unit in ipairs(units) do
        if not unit:IsMagicImmune() and not unit:IsInvulnerable() then
            ApplyDamage({
                victim = unit,
                attacker = caster,
                damage = (self.damage + (caster:GetIntellect() * (self.intToDamage/100))) * self.interval,
