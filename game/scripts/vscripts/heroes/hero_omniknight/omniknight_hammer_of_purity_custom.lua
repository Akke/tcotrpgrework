LinkLuaModifier("modifier_omniknight_hammer_of_purity_custom", "heroes/hero_omniknight/omniknight_hammer_of_purity_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_omniknight_hammer_of_purity_custom_debuff", "heroes/hero_omniknight/omniknight_hammer_of_purity_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_omniknight_hammer_of_purity_custom_thinker", "heroes/hero_omniknight/omniknight_hammer_of_purity_custom.lua", LUA_MODIFIER_MOTION_NONE)
