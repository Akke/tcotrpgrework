LinkLuaModifier("modifier_omniknight_purification_custom", "heroes/hero_omniknight/omniknight_purification_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_omniknight_purification_custom_casting", "heroes/hero_omniknight/omniknight_purification_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_omniknight_purification_custom_linger_heal", "heroes/hero_omniknight/omniknight_purification_custom.lua", LUA_MODIFIER_MOTION_NONE)
