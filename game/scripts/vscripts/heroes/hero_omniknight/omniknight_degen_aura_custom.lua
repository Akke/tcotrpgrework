LinkLuaModifier("modifier_omniknight_degen_aura_custom", "heroes/hero_omniknight/omniknight_degen_aura_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_omniknight_degen_aura_custom_debuff", "heroes/hero_omniknight/omniknight_degen_aura_custom.lua", LUA_MODIFIER_MOTION_NONE)
