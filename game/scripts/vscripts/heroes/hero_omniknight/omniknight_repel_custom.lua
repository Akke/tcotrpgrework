LinkLuaModifier("modifier_omniknight_repel_custom", "heroes/hero_omniknight/omniknight_repel_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_omniknight_repel_custom_buff", "heroes/hero_omniknight/omniknight_repel_custom.lua", LUA_MODIFIER_MOTION_NONE)
