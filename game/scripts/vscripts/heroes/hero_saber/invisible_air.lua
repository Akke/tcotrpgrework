...
LinkLuaModifier("modifier_saber_invisible_air_stacks", "heroes/hero_saber/invisible_air.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_saber_invisible_air_debuff", "heroes/hero_saber/invisible_air.lua", LUA_MODIFIER_MOTION_NONE)
