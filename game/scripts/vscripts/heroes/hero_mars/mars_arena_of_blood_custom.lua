...
LinkLuaModifier( "modifier_mars_arena_of_blood_custom", "heroes/hero_mars/mars_arena_of_blood_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_mars_arena_of_blood_custom_blocker", "heroes/hero_mars/mars_arena_of_blood_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_mars_arena_of_blood_custom_thinker", "heroes/hero_mars/mars_arena_of_blood_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_mars_arena_of_blood_custom_wall_aura", "heroes/hero_mars/mars_arena_of_blood_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_mars_arena_of_blood_custom_wall_aura_allies", "heroes/hero_mars/mars_arena_of_blood_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_mars_arena_of_blood_custom_spear_aura", "heroes/hero_mars/mars_arena_of_blood_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_mars_arena_of_blood_custom_projectile_aura", "heroes/hero_mars/mars_arena_of_blood_custom.lua", LUA_MODIFIER_MOTION_NONE )
