--[[
    ...
    https://github.com/EarthSalamander42/dota_imba/blob/master/game/scripts/vscripts/components/abilities/heroes/hero_mars.lua
]]--
LinkLuaModifier("modifier_mars_bulwark_custom", "heroes/hero_mars/mars_bulwark_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_mars_bulwark_custom_toggle", "heroes/hero_mars/mars_bulwark_custom.lua", LUA_MODIFIER_MOTION_NONE)
