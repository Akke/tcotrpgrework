LinkLuaModifier("modifier_mars_spear_of_mars_custom", "heroes/hero_mars/mars_spear_of_mars_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_mars_spear_of_mars_custom_trailblazer_thinker", "heroes/hero_mars/mars_spear_of_mars_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_mars_spear_of_mars_custom_casting", "heroes/hero_mars/mars_spear_of_mars_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_mars_spear_of_mars_custom_debuff", "heroes/hero_mars/mars_spear_of_mars_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_mars_spear_of_mars_custom_debuff_stunned", "heroes/hero_mars/mars_spear_of_mars_custom.lua", LUA_MODIFIER_MOTION_NONE)
