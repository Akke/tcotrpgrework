LinkLuaModifier("modifier_talent_bristleback_1", "heroes/hero_bristleback/talents/talent_bristleback_1.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_talent_bristleback_1_debuff", "heroes/hero_bristleback/talents/talent_bristleback_1.lua", LUA_MODIFIER_MOTION_NONE)
