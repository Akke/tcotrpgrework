...
LinkLuaModifier( "modifier_primal_beast_trample_custom", "heroes/hero_primal_beast/primal_beast_trample_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_primal_beast_trample_custom_talent_debuff", "heroes/hero_primal_beast/primal_beast_trample_custom.lua", LUA_MODIFIER_MOTION_NONE )
