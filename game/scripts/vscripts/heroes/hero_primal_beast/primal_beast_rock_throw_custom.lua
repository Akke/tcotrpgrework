LinkLuaModifier("modifier_primal_beast_rock_throw_custom", "heroes/hero_primal_beast/primal_beast_rock_throw_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_primal_beast_rock_throw_custom_debuff", "heroes/hero_primal_beast/primal_beast_rock_throw_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_primal_beast_rock_throw_custom_buff", "heroes/hero_primal_beast/primal_beast_rock_throw_custom.lua", LUA_MODIFIER_MOTION_NONE)
