...
LinkLuaModifier( "modifier_primal_beast_onslaught_custom_charge", "heroes/hero_primal_beast/primal_beast_onslaught_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_primal_beast_onslaught_custom", "heroes/hero_primal_beast/primal_beast_onslaught_custom.lua", LUA_MODIFIER_MOTION_HORIZONTAL )
LinkLuaModifier( "modifier_primal_beast_onslaught_custom_slowed", "heroes/hero_primal_beast/primal_beast_onslaught_custom.lua", LUA_MODIFIER_MOTION_HORIZONTAL )
LinkLuaModifier( "modifier_primal_beast_onslaught_custom_shard_debuff", "heroes/hero_primal_beast/primal_beast_onslaught_custom.lua", LUA_MODIFIER_MOTION_HORIZONTAL )
