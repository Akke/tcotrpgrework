...
LinkLuaModifier( "modifier_primal_beast_pulverize_custom", "heroes/hero_primal_beast/primal_beast_pulverize_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_primal_beast_pulverize_custom_debuff", "heroes/hero_primal_beast/primal_beast_pulverize_custom.lua", LUA_MODIFIER_MOTION_BOTH )
LinkLuaModifier( "modifier_primal_beast_pulverize_custom_dummy", "heroes/hero_primal_beast/primal_beast_pulverize_custom.lua", LUA_MODIFIER_MOTION_BOTH )
