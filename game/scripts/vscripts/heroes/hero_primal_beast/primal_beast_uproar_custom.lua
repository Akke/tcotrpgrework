LinkLuaModifier("modifier_primal_beast_uproar_custom", "heroes/hero_primal_beast/primal_beast_uproar_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_primal_beast_uproar_custom_buff", "heroes/hero_primal_beast/primal_beast_uproar_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_primal_beast_uproar_custom_status_resistance", "heroes/hero_primal_beast/primal_beast_uproar_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_primal_beast_uproar_custom_active", "heroes/hero_primal_beast/primal_beast_uproar_custom.lua", LUA_MODIFIER_MOTION_NONE)
