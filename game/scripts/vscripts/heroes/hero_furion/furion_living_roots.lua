...
LinkLuaModifier("modifier_furion_living_roots_custom_debuff_root", "heroes/hero_furion/furion_living_roots.lua", LUA_MODIFIER_MOTION_NONE) --- PETH WEFY INPARFANT
LinkLuaModifier("modifier_furion_living_roots_custom_buff", "heroes/hero_furion/furion_living_roots.lua", LUA_MODIFIER_MOTION_NONE) --- PETH WEFY INPARFANT
...
function modifier_furion_living_roots_custom_debuff:OnIntervalThink()
    ...
    local dot = ability:GetLevelSpecialValueFor("damage", (ability:GetLevel() - 1)) + (caster:GetIntellect() * (ability:GetSpecialValueFor("int_to_damage")/100))
