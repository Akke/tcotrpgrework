LinkLuaModifier("modifier_furion_sufferwood_sapling_custom", "heroes/hero_furion/furion_sufferwood_sapling_custom.lua", LUA_MODIFIER_MOTION_NONE) --- PETH WEFY INPARFANT
LinkLuaModifier("modifier_furion_sufferwood_sapling_custom_thinker", "heroes/hero_furion/furion_sufferwood_sapling_custom.lua", LUA_MODIFIER_MOTION_NONE) --- PETH WEFY INPARFANT
LinkLuaModifier("modifier_furion_sufferwood_sapling_custom_emitter", "heroes/hero_furion/furion_sufferwood_sapling_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_furion_sufferwood_sapling_custom_emitter_aura", "heroes/hero_furion/furion_sufferwood_sapling_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_furion_sufferwood_sapling_custom_debuff", "heroes/hero_furion/furion_sufferwood_sapling_custom.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_furion_sufferwood_sapling_custom_debuff:OnIntervalThink()
    local damage = self.damage + (self:GetCaster():GetIntellect() * (self.intToDamage/100)) * self.interval * self:GetStackCount()
