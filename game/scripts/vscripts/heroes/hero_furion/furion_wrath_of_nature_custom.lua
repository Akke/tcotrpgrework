LinkLuaModifier("modifier_furion_wrath_of_nature_custom", "heroes/hero_furion/furion_wrath_of_nature_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_furion_wrath_of_nature_custom_thinker", "heroes/hero_furion/furion_wrath_of_nature_custom.lua", LUA_MODIFIER_MOTION_NONE) 
LinkLuaModifier("modifier_furion_wrath_of_nature_custom_kill", "heroes/hero_furion/furion_wrath_of_nature_custom.lua", LUA_MODIFIER_MOTION_NONE) 
LinkLuaModifier("modifier_furion_wrath_of_nature_custom_buff", "heroes/hero_furion/furion_wrath_of_nature_custom.lua", LUA_MODIFIER_MOTION_NONE) 
...
function modifier_furion_wrath_of_nature_custom_thinker:BounceAttack(enemy, nJump)
    ...
    self.damage = (self.ability:GetSpecialValueFor("bounce_damage") + (self.caster:GetIntellect() * (self.ability:GetSpecialValueFor("int_to_damage")/100))) * (1 + (nJump * (self.jumpMultiplier/100)))
