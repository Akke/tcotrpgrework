...
function modifier_furion_breezing_wind_custom_buff_shard:GetModifierDamageOutgoing_Percentage()
    return self:GetAbility():GetSpecialValueFor("shard_bonus_damage_pct")
end