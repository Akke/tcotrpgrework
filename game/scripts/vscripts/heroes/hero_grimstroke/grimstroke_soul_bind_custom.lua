LinkLuaModifier("modifier_grimstroke_soul_bind_custom", "heroes/hero_grimstroke/grimstroke_soul_bind_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_grimstroke_soul_bind_custom_self_buff", "heroes/hero_grimstroke/grimstroke_soul_bind_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_grimstroke_soul_bind_custom_debuff", "heroes/hero_grimstroke/grimstroke_soul_bind_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_grimstroke_soul_bind_custom_debuff_mana_transfer", "heroes/hero_grimstroke/grimstroke_soul_bind_custom.lua", LUA_MODIFIER_MOTION_NONE)
