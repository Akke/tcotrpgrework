LinkLuaModifier("modifier_grimstroke_dark_artistry_custom", "heroes/hero_grimstroke/grimstroke_dark_artistry_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_grimstroke_dark_artistry_custom_shard", "heroes/hero_grimstroke/grimstroke_dark_artistry_custom.lua", LUA_MODIFIER_MOTION_NONE)
