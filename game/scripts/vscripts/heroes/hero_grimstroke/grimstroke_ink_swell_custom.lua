...
function modifier_grimstroke_ink_swell_custom:OnIntervalThink()
    ...
    for _,victim in ipairs(victims) do
        ...
        if victim:GetMana() >= victimMana then
            ...
            self.damageTable.damage = victimMana + (parent:GetIntellect()*(ability:GetSpecialValueFor("int_to_damage")/100))
...
function modifier_grimstroke_ink_swell_custom_aura:OnCreated()
    ...
    self.damage = damage + (caster:GetIntellect()*(ability:GetSpecialValueFor("int_to_damage")/100))
