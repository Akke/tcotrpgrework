LinkLuaModifier("modifier_grimstroke_dark_portrait_custom", "heroes/hero_grimstroke/grimstroke_dark_portrait_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_grimstroke_dark_portrait_custom_taunt", "heroes/hero_grimstroke/grimstroke_dark_portrait_custom.lua", LUA_MODIFIER_MOTION_NONE)
