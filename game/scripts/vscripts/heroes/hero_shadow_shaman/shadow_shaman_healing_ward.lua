LinkLuaModifier("modifier_shadow_shaman_healing_ward", "heroes/hero_shadow_shaman/shadow_shaman_healing_ward.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shadow_shaman_healing_ward_thinker", "heroes/hero_shadow_shaman/shadow_shaman_healing_ward.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shadow_shaman_healing_ward_aura", "heroes/hero_shadow_shaman/shadow_shaman_healing_ward.lua", LUA_MODIFIER_MOTION_NONE)
