LinkLuaModifier("modifier_shadow_shaman_bloodlust", "heroes/hero_shadow_shaman/shadow_shaman_bloodlust.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shadow_shaman_bloodlust_buff", "heroes/hero_shadow_shaman/shadow_shaman_bloodlust.lua", LUA_MODIFIER_MOTION_NONE)
