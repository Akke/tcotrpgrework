LinkLuaModifier("modifier_shadow_shaman_cog", "heroes/hero_shadow_shaman/shadow_shaman_cog.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shadow_shaman_cog_thinker", "heroes/hero_shadow_shaman/shadow_shaman_cog.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shadow_shaman_cog_taunt_debuff", "heroes/hero_shadow_shaman/shadow_shaman_cog.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shadow_shaman_cog_taunt_buff", "heroes/hero_shadow_shaman/shadow_shaman_cog.lua", LUA_MODIFIER_MOTION_NONE)
