LinkLuaModifier("modifier_shadow_shaman_death_ward", "heroes/hero_shadow_shaman/shadow_shaman_death_ward.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_shadow_shaman_death_ward_thinker", "heroes/hero_shadow_shaman/shadow_shaman_death_ward.lua", LUA_MODIFIER_MOTION_NONE)
...
function modifier_shadow_shaman_death_ward_thinker:OnAttackLanded(event)
    ...
    local damage = owner:GetIntellect() * (self:GetAbility():GetSpecialValueFor("damage_to_magical")/100)
...
function modifier_shadow_shaman_death_ward_thinker:OnRefresh()
    ...
    self.damage = owner:GetIntellect() * self.summonerStaff:GetSpecialValueFor("int_damage")
