LinkLuaModifier("modifier_dragon_knight_dragon_form_switch_custom", "heroes/hero_dragon_knight/dragon_knight_dragon_form_switch_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dragon_knight_dragon_form_switch_custom_green", "heroes/hero_dragon_knight/dragon_knight_dragon_form_switch_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dragon_knight_dragon_form_switch_custom_red", "heroes/hero_dragon_knight/dragon_knight_dragon_form_switch_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dragon_knight_dragon_form_switch_custom_blue", "heroes/hero_dragon_knight/dragon_knight_dragon_form_switch_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dragon_knight_dragon_form_switch_custom_black", "heroes/hero_dragon_knight/dragon_knight_dragon_form_switch_custom.lua", LUA_MODIFIER_MOTION_NONE)

LinkLuaModifier("modifier_dragon_knight_dragon_form_custom_green_poison_debuff", "heroes/hero_dragon_knight/dragon_form/dragon_form_green.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dragon_knight_dragon_form_custom_red_magic_debuff", "heroes/hero_dragon_knight/dragon_form/dragon_form_red.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dragon_knight_dragon_form_custom_blue_slow_debuff", "heroes/hero_dragon_knight/dragon_form/dragon_form_blue.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dragon_knight_dragon_form_custom_black_armor_debuff", "heroes/hero_dragon_knight/dragon_form/dragon_form_black.lua", LUA_MODIFIER_MOTION_NONE)
