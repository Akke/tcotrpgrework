...
LinkLuaModifier( "modifier_dragon_knight_breathe_fire_custom", "heroes/hero_dragon_knight/dragon_knight_breathe_fire_custom.lua", LUA_MODIFIER_MOTION_NONE )
LinkLuaModifier( "modifier_dragon_knight_breathe_fire_custom_self", "heroes/hero_dragon_knight/dragon_knight_breathe_fire_custom.lua", LUA_MODIFIER_MOTION_NONE )
