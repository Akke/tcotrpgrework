LinkLuaModifier("modifier_dragon_knight_dragon_blood_custom", "heroes/hero_dragon_knight/dragon_knight_dragon_blood_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dragon_knight_dragon_blood_custom_poison_debuff", "heroes/hero_dragon_knight/dragon_knight_dragon_blood_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dragon_knight_dragon_blood_custom_fire_shield", "heroes/hero_dragon_knight/dragon_knight_dragon_blood_custom.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_dragon_knight_dragon_blood_custom_fire_shield_aura", "heroes/hero_dragon_knight/dragon_knight_dragon_blood_custom.lua", LUA_MODIFIER_MOTION_NONE)
