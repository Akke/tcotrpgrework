LinkLuaModifier("modifier_trigger_super_hypothermia", "super_hypothermia.lua", LUA_MODIFIER_MOTION_NONE)
LinkLuaModifier("modifier_trigger_super_hypothermia_debuff", "super_hypothermia.lua", LUA_MODIFIER_MOTION_NONE)
