...
function GetPlayerAbilities(player)
  ...
  for i=0, player:GetAbilityCount()-1 do
      ...
      if abil ~= nil then
          ...
          if not string.match(name, "special_bonus") and not string.match(name, "chicken_ability_1_cancel") and not string.match(name, "talent_") and not string.match(name, "generic_hidden") and name ~= "twin_gate_portal_warp" and name ~= "ability_pluck_famango" and name ~= "ability_lamp_use" and name ~= "ability_capture" and name ~= "abyssal_underlord_portal_warp" then
