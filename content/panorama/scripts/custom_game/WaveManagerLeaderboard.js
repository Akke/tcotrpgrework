var WaveManagerLeaderboard = (function() {
    function WaveManagerLeaderboard(context) {
        var _this = this;
        ...
        this.CreateButton = function() {
            ...
            if (old) {
                old.forEach(async (child) => {
                    if (child.id == "WaveManagerLeaderboardButtonImage") {
                        child.RemoveAndDeleteChildren();
                        await child.DeleteAsync(0);
                    }
                });
            ...
            const image = $.CreatePanel("Button", context, "WaveManagerLeaderboardButtonImage")
            ...
            image.SetPanelEvent(
                "onmouseover", 
                function(){
                    $.DispatchEvent("DOTAShowTextTooltip", image, $.Localize("#leaderboard_header"));
                }
            )
            ...
            // Discord
            const imageDiscord = $.CreatePanel("Button", context, "WaveManagerLeaderboardButtonImageDiscord")
            imageDiscord.SetParent(buttonParent)

            buttonParent.MoveChildAfter(imageDiscord, buttonParent.FindChildTraverse("SettingsButton"))

            imageDiscord.SetPanelEvent(
                "onmouseover", 
                function(){
                    $.DispatchEvent("DOTAShowTextTooltip", imageDiscord, $.Localize("#button_top_discord"));
                }
            )
            ...
            // WeChat
            const imageWeChat = $.CreatePanel("Button", context, "WaveManagerLeaderboardButtonImageWeChat")
            imageWeChat.SetParent(buttonParent)

            buttonParent.MoveChildAfter(imageWeChat, buttonParent.FindChildTraverse("SettingsButton"))

            imageWeChat.SetPanelEvent(
                "onmouseover", 
                function(){
                    $.DispatchEvent("DOTAShowTextTooltip", imageWeChat, $.Localize("#button_top_wechat"));
                }
            )
            ...
            imageWeChat.SetPanelEvent(
                "onmouseactivate", 
                function(){
                    $.DispatchEvent('ExternalBrowserGoToURL', 'https://cdn.discordapp.com/attachments/1152954492963274812/1154721275500040192/2b9b3060309b4c7c0c05d209f1c9eec.png');
                }
            )
        }
        ...
        this.CreatePlayerItem = function(steam, points, rank) {
            ...
            // Player item
            const item = $.CreatePanel("Panel", _this.itemContainer, "WaveManagerLeaderboardItem");

            const playerContainer = $.CreatePanel("Panel", item, "WaveManagerLeaderboardItemPlayerContainer");

            const playerImage = $.CreatePanel("DOTAAvatarImage", playerContainer, "WaveManagerLeaderboardItemPlayerImage");
            playerImage.steamid = steam
            playerImage.style.width = "36px";
            playerImage.style.height = "36px";

            const playerRank = $.CreatePanel("Label", playerContainer, "WaveManagerLeaderboardItemPlayerRank");
            playerRank.text = "#"+rank

            const playerName = $.CreatePanel("DOTAUserName", playerContainer, "WaveManagerLeaderboardItemPlayerName");
            playerName.steamid = steam

            const scoreContainer = $.CreatePanel("Panel", item, "WaveManagerLeaderboardItemScoreContainer");
            const score = $.CreatePanel("Label", scoreContainer, "WaveManagerLeaderboardItemScore");
            score.text = points
        ...
        this.container = $.CreatePanel("Panel", context, "WaveManagerLeaderboardContainer");

        this.container.style.visibility = this.visibility
        this.container.style.opacity = this.opacity

        // Header
        const header = $.CreatePanel("Label", this.container, "WaveManagerLeaderboardHeader");
        header.text = $.Localize("#leaderboard_header")

        // Difficulties
        this.difficultyContainer = $.CreatePanel("Panel", this.container, "WaveManagerLeaderboardDifficultyContainer");
        this.difficultyContainerChildren = $.CreatePanel("Panel", this.difficultyContainer, "WaveManagerLeaderboardDifficultyContainerChildren");

        // Easy
        this.difficultyButton_Easy = $.CreatePanel("Button", this.difficultyContainerChildren, "WaveManagerLeaderboardDifficultyButton");
        ...
        // Normal
        this.difficultyButton_Normal = $.CreatePanel("Button", this.difficultyContainerChildren, "WaveManagerLeaderboardDifficultyButton");
        ...
        // Hard
        this.difficultyButton_Hard = $.CreatePanel("Button", this.difficultyContainerChildren, "WaveManagerLeaderboardDifficultyButton");
        ...
        // Impossible
        this.difficultyButton_Impossible = $.CreatePanel("Button", this.difficultyContainerChildren, "WaveManagerLeaderboardDifficultyButton");
        ...
        // Hell
        this.difficultyButton_Hell = $.CreatePanel("Button", this.difficultyContainerChildren, "WaveManagerLeaderboardDifficultyButton");
        ...
        // Hardcore
        this.difficultyButton_Hardcore = $.CreatePanel("Button", this.difficultyContainerChildren, "WaveManagerLeaderboardDifficultyButton");
        ...
        // Difficulty Header
        this.difficultyHeader = $.CreatePanel("Label", this.container, "WaveManagerLeaderboardDifficultyHeader");
        this.difficultyHeader.text = "Normal"
        this.UpdateSelectedButton(2)

        this.itemContainer = $.CreatePanel("Panel", this.container, "WaveManagerLeaderboardItemContainer");
    ...
    return WaveManagerLeaderboard;
}());

var ui = new WaveManagerLeaderboard($.GetContextPanel());
