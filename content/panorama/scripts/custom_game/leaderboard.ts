class LeaderboardUI {
    ...
    constructor(panel: Panel) {
        ...
        // ALL players
        $.AsyncWebRequest( 'http://70.34.202.91/api/leaderboard/all?start=0&end=100',
        {
            type: 'GET',
            dataType : "json",
        ...
        // ONE Player
        $.AsyncWebRequest( 'http://70.34.202.91/api/leaderboard/all?target=' + Game.GetLocalPlayerInfo().player_steamid,
        {
            type: 'GET',
            dataType : "json",
            headers : { 'Content-type' : 'application/json', 'Accept' : 'application/json'},
